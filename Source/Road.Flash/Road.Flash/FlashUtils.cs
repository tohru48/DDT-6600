...
namespace Road.Flash
{
    ...
    {
        public static XElement CreatescenecollecrandomnpcInfo()
        {
            return new XElement("item", new XAttribute("NickName", "Hime Chibi"), new XAttribute("Sex", 1), new XAttribute("Hair", 3251), new XAttribute("Glass", 2213), new XAttribute("Face", 6224), new XAttribute("Eye", 4240));
        }

        public static XElement CreateSearchGoodsTemp(SearchGoodsTempInfo info)
        {
            return new XElement("item", new XAttribute("StarID", info.StarID), new XAttribute("NeedMoney", info.NeedMoney), new XAttribute("DestinationReward", info.DestinationReward), new XAttribute("VIPLevel", info.VIPLevel), new XAttribute("ExtractNumber", info.ExtractNumber));
        }
        ...
        {
            return new XElement("Item", new XAttribute("Type", info.Type), new XAttribute("ShopId", info.ShopId));
        }

        public static XElement CreateMissionEnergyPrice(MissionEnergyInfo info)
        {
            return new XElement("Item", new XAttribute("Count", info.Count), new XAttribute("Money", info.Money), new XAttribute("Energy", info.Energy));
        }
        ...
        public static XElement CreateShopInfo(ShopItemInfo shop)
        {
            return new XElement("Item", 
                ...
                new XAttribute("IsVouch", shop.IsCheap), 
        ...
        {
            return new XElement("Item_Good", new XAttribute("QuestID", info.QuestID), new XAttribute("RewardItemID", info.RewardItemID), new XAttribute("IsSelect", info.IsSelect), new XAttribute("RewardItemValid", info.RewardItemValid), new XAttribute("RewardItemCount1", info.RewardItemCount1), new XAttribute("RewardItemCount2", info.RewardItemCount2), new XAttribute("RewardItemCount3", info.RewardItemCount3), new XAttribute("RewardItemCount4", info.RewardItemCount4), new XAttribute("RewardItemCount5", info.RewardItemCount5), new XAttribute("StrengthenLevel", info.StrengthenLevel), new XAttribute("AttackCompose", info.AttackCompose), new XAttribute("DefendCompose", info.DefendCompose), new XAttribute("AgilityCompose", info.AgilityCompose), new XAttribute("LuckCompose", info.LuckCompose), new XAttribute("IsCount", info.IsCount), new XAttribute("IsBind", info.IsBind));
        }
        ...
        {
            return new XElement("Rate", new XAttribute("BindMoneyRate", info.BindMoneyRate), new XAttribute("ExpRate", info.ExpRate), new XAttribute("GoldRate", info.GoldRate), new XAttribute("ExploitRate", info.ExploitRate), new XAttribute("CanOneKeyFinishTime", info.CanOneKeyFinishTime));
        }
        ...
        public static XElement CreateActiveInfo(ActiveInfo info)
        {
            return new XElement("Item", 
                ...
                new XAttribute("EndDate",info.EndDate == DateTime.MinValue ? "" : info.EndDate.ToString("yyyy-MM-dd HH:mm:ss")), 
