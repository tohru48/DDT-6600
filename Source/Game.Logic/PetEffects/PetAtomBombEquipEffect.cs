...
namespace Game.Logic.PetEffects
{
  public class PetAtomBombEquipEffect : BasePetEffect
  {
    ...
    {
      this.int_0 = count;
      this.int_1 = probability == -1 ? 2500 : probability;
      this.evbpqAgdVX = type;
      this.int_2 = delay;
      this.int_3 = skillId;
    }
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetAtomBombEquipEffect) is PetAtomBombEquipEffect ofType))
