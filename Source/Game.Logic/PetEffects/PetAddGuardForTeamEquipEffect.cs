...
namespace Game.Logic.PetEffects
{
  public class PetAddGuardForTeamEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetAddGuardForTeamEquipEffect) is PetAddGuardForTeamEquipEffect ofType))
    ...
    private void method_0(Player player_0)
    {
      ...
      foreach (Living allTeamPlayer in player_0.Game.GetAllTeamPlayers((Living) player_0))
        allTeamPlayer.AddPetEffect((AbstractPetEffect) new PetAddGuardEquip(this.int_1, this.int_4, this.Info.ID.ToString()), 0);
    }
  }
}
