...
namespace Game.Logic.PetEffects
{
  public class PetRevertBloodAllPlayerAroundEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetRevertBloodAllPlayerAroundEquipEffect) is PetRevertBloodAllPlayerAroundEquipEffect ofType))
