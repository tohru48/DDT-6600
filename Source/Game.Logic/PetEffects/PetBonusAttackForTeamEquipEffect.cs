...
namespace Game.Logic.PetEffects
{
  public class PetBonusAttackForTeamEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetBonusAttackForTeamEquipEffect) is PetBonusAttackForTeamEquipEffect ofType))
    ...
    private void method_0(Player player_0)
    {
      ...
      {
        allTeamPlayer.AddPetEffect((AbstractPetEffect) new PetAddAttackEquip(this.int_1, this.int_4, this.Info.ID.ToString()), 0);
