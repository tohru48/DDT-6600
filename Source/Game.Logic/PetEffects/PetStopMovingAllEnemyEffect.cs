...
namespace Game.Logic.PetEffects
{
  public class PetStopMovingAllEnemyEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetStopMovingAllEnemyEffect) is PetStopMovingAllEnemyEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      foreach (Living allEnemyPlayer in living_0.Game.GetAllEnemyPlayers(living_0))
        allEnemyPlayer.AddPetEffect((AbstractPetEffect) new PetStopMovingEquip(this.int_1, this.Info.ID.ToString()), 0);
    }
  }
}
