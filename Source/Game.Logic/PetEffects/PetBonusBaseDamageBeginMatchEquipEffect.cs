...
namespace Game.Logic.PetEffects
{
  public class PetBonusBaseDamageBeginMatchEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetBonusBaseDamageBeginMatchEquipEffect) is PetBonusBaseDamageBeginMatchEquipEffect ofType))
    ...
    {
      player.PetEffects.BonusBaseDamage += this.int_5;
    }
