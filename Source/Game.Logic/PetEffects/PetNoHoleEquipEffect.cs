...
namespace Game.Logic.PetEffects
{
  public class PetNoHoleEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.NoHoleEquipEffect) is PetNoHoleEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      new PetNoHoleEffect(this.int_1, this.Info.ID.ToString()).Start(living_0);
    }
  }
}
