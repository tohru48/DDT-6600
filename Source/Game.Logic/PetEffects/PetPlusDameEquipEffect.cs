...
namespace Game.Logic.PetEffects
{
  public class PetPlusDameEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetPlusDameEquipEffect) is PetPlusDameEquipEffect ofType))
    ...
    {
      if (this.rand.Next(10000) >= this.int_2 || living_0.PetEffects.AddDameValue >= this.int_5 * 5)
        return;
