...
namespace Game.Logic.PetEffects
{
  public class PetAddBloodForSelfEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetAddBloodForSelfEquipEffect) is PetAddBloodForSelfEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      new PetAddBloodForSelfEquip(this.int_1, this.int_4, this.Info.ID.ToString()).Start(living_0);
    }
  }
}
