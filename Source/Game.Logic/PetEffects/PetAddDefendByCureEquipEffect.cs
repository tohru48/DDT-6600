...
namespace Game.Logic.PetEffects
{
  public class PetAddDefendByCureEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetAddDefendByCureEquipEffect) is PetAddDefendByCureEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      new PetAddDefendEquip(this.int_1, this.int_4, this.Info.ID.ToString()).Start(living_0);
    }
  }
}
