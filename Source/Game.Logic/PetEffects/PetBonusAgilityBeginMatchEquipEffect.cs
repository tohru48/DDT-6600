...
namespace Game.Logic.PetEffects
{
  public class PetBonusAgilityBeginMatchEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetBonusAgilityBeginMatchEquipEffect) is PetBonusAgilityBeginMatchEquipEffect ofType))
    ...
    {
      player.PetEffects.BonusAgility += this.int_5;
    }
