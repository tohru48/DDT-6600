...
namespace Game.Logic.PetEffects
{
  public class PetBonusDefendTeamBeginMatchEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetBonusDefendTeamBeginMatchEquipEffect) is PetBonusDefendTeamBeginMatchEquipEffect ofType))
    ...
    {
      foreach (Living allTeamPlayer in living_0.Game.GetAllTeamPlayers(living_0))
        allTeamPlayer.AddPetEffect((AbstractPetEffect) new PetBonusAttackBeginMatchEquip(this.int_1, this.int_4, this.Info.ID.ToString()), 0);
    }
  }
}
