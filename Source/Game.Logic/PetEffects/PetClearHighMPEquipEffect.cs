...
namespace Game.Logic.PetEffects
{
  public class PetClearHighMPEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetClearHighMPEquipEffect) is PetClearHighMPEquipEffect ofType))
    ...
    {
      if (this.rand.Next(10000) >= this.int_2 || !(living_0.PetEffectList.GetOfType(ePetEffectType.PetAddHighMPEquipEffect) is PetAddHighMPEquipEffect ofType) || living_0.TurnNum <= 0)
        return;
      ofType.Stop();
    }
  }
