...
namespace Game.Logic.PetEffects
{
  public class PetReduceAttackAllEnemyEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetReduceAttackAllEnemyEquipEffect) is PetReduceAttackAllEnemyEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      {
        allEnemyPlayer.AddPetEffect((AbstractPetEffect) new PetReduceAttackEquip(this.int_1, this.int_4, this.Info.ID.ToString()), 0);
