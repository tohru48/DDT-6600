...
namespace Game.Logic.PetEffects
{
  public class PetReduceBaseGuardEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetReduceBaseGuardEquipEffect) is PetReduceBaseGuardEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      new PetReduceBaseGuardEquip(this.int_1, this.int_4, this.Info.ID.ToString()).Start(living_0);
    }
  }
}
