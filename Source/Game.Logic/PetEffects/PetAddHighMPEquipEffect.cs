...
namespace Game.Logic.PetEffects
{
  public class PetAddHighMPEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetAddHighMPEquipEffect) is PetAddHighMPEquipEffect ofType))
    ...
    {
      if (this.rand.Next(10000) >= this.int_2 || 96 != this.int_4)
        return;
      ((TurnedLiving) living_0).AddPetMP(this.int_5);
    }
  }
}
