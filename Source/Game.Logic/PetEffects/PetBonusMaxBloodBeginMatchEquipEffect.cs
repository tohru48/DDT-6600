...
namespace Game.Logic.PetEffects
{
  public class PetBonusMaxBloodBeginMatchEquipEffect : BasePetEffect
  {
    ...
    {
      if (!(living.PetEffectList.GetOfType(ePetEffectType.PetBonusMaxBloodBeginMatchEquipEffect) is PetBonusMaxBloodBeginMatchEquipEffect ofType))
    ...
    {
      player.PetEffects.MaxBlood += this.int_5;
    }
