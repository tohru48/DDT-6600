...
// Type: Game.Logic.HorseEffects.HorseFrostEquipEffect
...
{
  public class HorseFrostEquipEffect : BaseHorseEffect
  {
    private int int_0;
    private int int_1;
    private int int_2;
    ...
    public HorseFrostEquipEffect(
      ...
      int delay,
      string elementID)
      : base(eHorseEffectType.HorseFrostEquipEffect, elementID)
    {
      this.int_1 = count;
    ...
    {
      if (!(living.HorseEffectList.GetOfType(eHorseEffectType.HorseFrostEquipEffect) is HorseFrostEquipEffect ofType))
    ...
    private void method_0(Living living_0)
    {
      ...
      if (living_0.IsLiving)
        ...
        (living_0.Game.CurrentLiving as Player).SetBall(1);
    }
  }
}
