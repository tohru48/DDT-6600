...
// Type: Game.Logic.HorseEffects.BaseHorseEffect
...
{
  public class BaseHorseEffect : AbstractHorseEffect
  {
    public BaseHorseEffect(eHorseEffectType type, string elementId)
      : base(type, elementId)
    {
    }
