...
namespace Game.Logic.Effects
{
  public class AtomBombEquipEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.AtomBomb) is AtomBombEquipEffect ofType))
    ...
    private void method_0(Player player_0)
    {
      ...
      player_0.Game.AddAction((IAction) new LivingSayAction((Living) player_0, LanguageMgr.GetTranslation("AtomBombEquipEffect.msg"), 9, 0, 1000));
    }
  }
}
