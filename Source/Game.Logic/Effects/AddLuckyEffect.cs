...
namespace Game.Logic.Effects
{
  public class AddLuckyEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.AddLuckyEffect) is AddLuckyEffect ofType))
    ...
    private void method_1(Player player_0)
    {
      if (player_0.CurrentBall.IsSpecial())
        return;
      player_0.Lucky -= (double) this.int_2;
      this.int_2 = 0;
      ...
      this.IsTrigger = true;
      player_0.Lucky += (double) this.int_0;
      ...
      player_0.Game.AddAction((IAction) new LivingSayAction((Living) player_0, LanguageMgr.GetTranslation("AddLuckyEffect.msg"), 9, 0, 1000));
    }
  }
}
