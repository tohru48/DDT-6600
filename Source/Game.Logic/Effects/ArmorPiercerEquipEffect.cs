...
// Type: Game.Logic.Effects.ArmorPiercerEquipEffect
...
namespace Game.Logic.Effects
{
  public class ArmorPiercerEquipEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.ArmorPiercer) is ArmorPiercerEquipEffect ofType))
