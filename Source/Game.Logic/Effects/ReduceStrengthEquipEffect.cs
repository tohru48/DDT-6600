...
// Type: Game.Logic.Effects.ReduceStrengthEquipEffect
...
namespace Game.Logic.Effects
{
  public class ReduceStrengthEquipEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.ReduceStrengthEquipEffect) is ReduceStrengthEquipEffect ofType))
    ...
    private void method_0(Living living_0, Living living_1, int int_2, int int_3)
    {
      if (!this.IsTrigger)
        return;
      living_1.AddEffect((AbstractEffect) new ReduceStrengthEffect(2, this.int_0), 0);
    }
    ...
    private void method_1(Player player_0)
    {
      ...
      player_0.Game.AddAction((IAction) new LivingSayAction((Living) player_0, LanguageMgr.GetTranslation("ReduceStrengthEquipEffect.msg"), 9, 0, 1000));
    }
  }
}
