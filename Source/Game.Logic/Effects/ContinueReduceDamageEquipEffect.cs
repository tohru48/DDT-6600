...
namespace Game.Logic.Effects
{
  public class ContinueReduceDamageEquipEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.ContinueReduceBaseDamageEquipEffect) is ContinueReduceDamageEquipEffect ofType))
    ...
    private void method_0(Living living_0, Living living_1, int int_2, int int_3)
    {
      if (!this.IsTrigger)
        return;
      living_1.AddEffect((AbstractEffect) new ContinueReduceDamageEffect(2), 0);
    }
    ...
    private void method_1(Player player_0)
    {
      ...
      player_0.Game.AddAction((IAction) new LivingSayAction((Living) player_0, LanguageMgr.GetTranslation("ContinueReduceBaseDamageEquipEffect.msg"), 9, 0, 1000));
    }
  }
}
