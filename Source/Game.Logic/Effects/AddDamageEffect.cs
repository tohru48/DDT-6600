...
namespace Game.Logic.Effects
{
  public class AddDamageEffect : BasePlayerEffect
  {
    ...
    {
      if (!(living.EffectList.GetOfType(eEffectType.AddDamageEffect) is AddDamageEffect ofType))
    ...
    protected override void OnAttachedToPlayer(Player player)
    {
      ...
      player.PlayerShoot += new PlayerEventHandle(this.method_2);
    ...
    private void method_2(Player player_0)
    {
      ...
      player_0.Game.AddAction((IAction) new LivingSayAction((Living) player_0, LanguageMgr.GetTranslation("AddDamageEffect.msg"), 9, 0, 1000));
    }
  }
}
