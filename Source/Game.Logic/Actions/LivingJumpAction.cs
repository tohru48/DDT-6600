...
namespace Game.Logic.Actions
{
  public class LivingJumpAction : BaseAction
  {
    ...
    protected override void ExecuteImp(BaseGame game, long tick)
    {
      ...
      {
        this.bool_0 = true;
        game.method_25(this.living_0, this.int_0, this.int_1, this.int_2, this.string_0, this.int_3);
      }
      if (this.int_1 < this.living_0.Y - this.int_2)
      {
        this.living_0.SetXY(this.int_0, this.living_0.Y - this.int_2);
      }
      else
      {
