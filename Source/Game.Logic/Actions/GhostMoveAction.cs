...
namespace Game.Logic.Actions
{
  public class GhostMoveAction : BaseAction
  {
    ...
    protected override void ExecuteImp(BaseGame game, long tick)
    {
      ...
      {
        this.bool_0 = true;
        game.method_21(this.player_0, 2, this.point_0.X, this.point_0.Y, this.point_1.X > 0 ? (byte) 1 : byte.MaxValue, this.player_0.IsLiving);
      }
      if (this.point_0.Distance(this.player_0.X, this.player_0.Y) > 2.0)
      {
