...
namespace Bussiness
{
  public class ConsortiaBussiness : BaseBussiness
  {
    ...
    {
      List<ConsortiaInfo> consortiaInfoList1 = new List<ConsortiaInfo>();
      SqlDataReader ResultDataReader = (SqlDataReader) null;
      try
      {
        ...
        {
          List<ConsortiaInfo> consortiaInfoList2 = consortiaInfoList1;
          ...
          consortiaInfoList2.Add(consortiaInfo2);
        }
      }
      catch (Exception ex)
      {
      ...
      return consortiaInfoList1.ToArray();
    }
      ...
      try
      {
        ...
        if (ResultDataReader.Read())
          return new ConsortiaInfo()
          {
            ...
            extendAvailableNum = (int) ResultDataReader["extendAvailableNum"]
          };
      }
      catch (Exception ex)
      {
    ...
    public bool ScanConsortia(ref string noticeID)
    {
      ...
      try
      {
        ...
        if (flag = (int) SqlParameters[1].Value == 0)
      ...
      int userID)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("V_Consortia_Apply_Users", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
          consortiaApplyUserInfoList.Add(new ConsortiaApplyUserInfo()
          {
            ID = (int) row["ID"],
      ...
      int inviteID)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("V_Consortia_Invite", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
          consortiaInviteUserInfoList.Add(new ConsortiaInviteUserInfo()
          {
            ID = (int) row["ID"],
            CelebCount = (int) row["CelebCount"],
            ChairmanName = row["ChairmanName"].ToString(),
      ...
      int dutyID)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("Consortia_Duty", queryWhere, page, size, "*", fdOreder, "DutyID", ref total).Rows)
          consortiaDutyInfoList.Add(new ConsortiaDutyInfo()
          {
            DutyID = (int) row["DutyID"],
            ConsortiaID = (int) row["ConsortiaID"],
            DutyName = row["DutyName"].ToString(),
      ...
      int state)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("V_Consortia_Apply_Ally", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
          consortiaApplyAllyInfoList.Add(new ConsortiaApplyAllyInfo()
          {
            ID = (int) row["ID"],
            CelebCount = (int) row["CelebCount"],
            ChairmanName = row["ChairmanName"].ToString(),
    ...
    {
      Dictionary<int, int> consortiaByAlly = new Dictionary<int, int>();
      SqlDataReader ResultDataReader = (SqlDataReader) null;
      try
      {
        SqlParameter[] SqlParameters = new SqlParameter[1]
        ...
        while (ResultDataReader.Read())
        {
          if ((int) ResultDataReader["Consortia1ID"] != consortiaID)
            consortiaByAlly.Add((int) ResultDataReader["Consortia1ID"], (int) ResultDataReader["State"]);
          else
            consortiaByAlly.Add((int) ResultDataReader["Consortia2ID"], (int) ResultDataReader["State"]);
        }
      }
      catch (Exception ex)
      {
    ...
    public ConsortiaAllyInfo[] GetConsortiaAllyAll()
    {
      ...
      try
      {
        ...
        while (ResultDataReader.Read())
          consortiaAllyInfoList.Add(new ConsortiaAllyInfo()
          {
      ...
      int consortiaID)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("Consortia_Event", queryWhere, page, size, "*", fdOreder, "ID", ref total).Rows)
          consortiaEventInfoList.Add(new ConsortiaEventInfo()
          {
            ID = (int) row["ID"],
            ConsortiaID = (int) row["ConsortiaID"],
            Date = (DateTime) row["Date"],
    ...
    public ConsortiaBufferTempInfo[] GetAllConsortiaBuffTemp()
    {
      ...
      try
      {
        ...
        while (ResultDataReader.Read())
          consortiaBufferTempInfoList.Add(new ConsortiaBufferTempInfo()
          {
            id = (int) ResultDataReader["id"],
    ...
    {
      ConsortiaEquipControlInfo consortiaEuqipRiches = (ConsortiaEquipControlInfo) null;
      SqlDataReader ResultDataReader = (SqlDataReader) null;
      try
      {
        SqlParameter[] SqlParameters = new SqlParameter[3]
        ...
        if (ResultDataReader.Read())
        {
          consortiaEuqipRiches = new ConsortiaEquipControlInfo();
          consortiaEuqipRiches.ConsortiaID = (int) ResultDataReader["ConsortiaID"];
          consortiaEuqipRiches.Level = (int) ResultDataReader[nameof (Level)];
          consortiaEuqipRiches.Riches = (int) ResultDataReader["Riches"];
          consortiaEuqipRiches.Type = (int) ResultDataReader["Type"];
          return consortiaEuqipRiches;
        }
      }
      catch (Exception ex)
      {
      ...
      {
        consortiaEuqipRiches = new ConsortiaEquipControlInfo();
        consortiaEuqipRiches.ConsortiaID = consortiaID;
        consortiaEuqipRiches.Level = Level;
        consortiaEuqipRiches.Riches = 100;
        consortiaEuqipRiches.Type = type;
      }
      return consortiaEuqipRiches;
    }
      ...
      int type)
    {
      ...
      try
      {
        ...
        foreach (DataRow row in (InternalDataCollectionBase) this.GetPage("Consortia_Equip_Control", queryWhere, page, size, "*", fdOreder, "ConsortiaID", ref total).Rows)
          equipControlInfoList.Add(new ConsortiaEquipControlInfo()
          {
            ConsortiaID = (int) row["ConsortiaID"],
            Level = (int) row["Level"],
            Riches = (int) row["Riches"],
