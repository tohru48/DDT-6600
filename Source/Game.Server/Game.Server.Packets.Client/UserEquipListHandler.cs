	...
	public class UserEquipListHandler : IPacketHandler
	{
		public int HandlePacket(GameClient client, GSPacketIn packet)
		{
			...
			if (gamePlayer != null)
			{
				...
				list4 = gamePlayer.MagicStoneBag.GetItems(0, 31);
			}
			else
			{
				...
				playerInfo.ZoneName = client.Player.ZoneName;
				...
				list4 = playerBussiness.GetUserMagicstoneEuqip(num);
			}
			if (playerInfo != null && list != null && list2 != null && list3 != null && list4 != null)
			{
				client.Player.Out.SendUserEquip(playerInfo, list, list3, list2, list4);
