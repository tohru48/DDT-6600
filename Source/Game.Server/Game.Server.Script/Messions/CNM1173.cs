...
// Type: GameServerScript.AI.Messions.CNM1173
...
namespace GameServerScript.AI.Messions
{
  public class CNM1173 : AMissionControl
  {
    ...
    {
      base.DoOther();
      int index = this.Game.Random.Next(0, CNM1173.KillChat.Length);
      if (this.m_boss == null)
        return;
      this.m_boss.Say(CNM1173.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (this.m_boss == null || !this.m_boss.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, CNM1173.ShootedChat.Length);
      this.m_boss.Say(CNM1173.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
