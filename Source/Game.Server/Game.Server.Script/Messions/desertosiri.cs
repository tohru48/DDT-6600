...
// Type: GameServerScript.AI.Messions.desertosiri
...
{
  public class desertosiri : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private int bossID = 99999;
    private int kill = 0;
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.SetMap(11039);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 899, 190, -1, 4, "");
