...
// Type: GameServerScript.AI.Messions.CNM1177
...
namespace GameServerScript.AI.Messions
{
  public class CNM1177 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      this.m_king.Say("你们知道的太多了，我不能让你们继续活着！", 0, 3000);
    ...
    public override void DoOther()
    {
      ...
      if (this.m_king == null)
        return;
      int index = this.Game.Random.Next(0, CNM1177.KillChat.Length);
      this.m_king.Say(CNM1177.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (!this.m_king.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, CNM1177.ShootedChat.Length);
      this.m_king.Say(CNM1177.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
