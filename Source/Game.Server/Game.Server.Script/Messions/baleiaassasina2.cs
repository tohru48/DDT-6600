...
// Type: GameServerScript.AI.Messions.baleiaassasina2
...
{
  public class baleiaassasina2 : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private int bossID = 88889;
    private int kill = 0;
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.SetMap(12009);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 1060, 700, -1, 4, "");
