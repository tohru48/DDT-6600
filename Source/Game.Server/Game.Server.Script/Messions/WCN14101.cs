...
// Type: GameServerScript.AI.Messions.WCN14101
...
{
  public class WCN14101 : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private SimpleNpc ball = (SimpleNpc) null;
    private int bossID = 14002;
    private int ballID = 14001;
    private int holdTurn = 20;
