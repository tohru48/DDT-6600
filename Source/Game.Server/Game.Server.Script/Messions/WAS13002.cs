...
// Type: GameServerScript.AI.Messions.WAS13002
...
namespace GameServerScript.AI.Messions
{
  public class WAS13002 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(2, "image/game/effect/10/zhuzi.swf", "asset.game.ten.zhuzi");
      this.Game.AddLoadingFile(2, "image/game/effect/10/tuteng.swf", "asset.game.ten.pilao");
      this.Game.AddLoadingFile(2, "image/game/effect/10/tuteng.swf", "asset.game.ten.jiaodu");
      this.Game.AddLoadingFile(2, "image/game/effect/10/tuteng.swf", "asset.game.ten.baozha");
