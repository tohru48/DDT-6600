...
// Type: GameServerScript.AI.Messions.ETH3203
...
namespace GameServerScript.AI.Messions
{
  public class ETH3203 : AMissionControl
  {
    ...
    public override void DoOther()
    {
      ...
      {
        int index = this.Game.Random.Next(0, ETH3203.KillChat.Length);
        this.m_king.Say(ETH3203.KillChat[index], 0, 0);
        this.boss.Say(ETH3203.KillChat[index], 0, 0);
      }
      else
      {
        int index = this.Game.Random.Next(0, ETH3203.KillChat.Length);
    ...
    public override void OnShooted()
    {
      ...
      if (this.m_king.IsLiving)
      {
        int index = this.Game.Random.Next(0, ETH3203.ShootedChat.Length);
        this.m_king.Say(ETH3203.ShootedChat[index], 0, 1500);
        this.boss.Say(ETH3203.ShootedChat[index], 0, 1500);
      }
      else
      {
        int index = this.Game.Random.Next(0, ETH3203.ShootedChat.Length);
