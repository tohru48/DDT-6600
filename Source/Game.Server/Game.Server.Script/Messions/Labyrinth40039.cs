...
// Type: GameServerScript.AI.Messions.Labyrinth40039
...
namespace GameServerScript.AI.Messions
{
  public class Labyrinth40039 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      {
        if (this.birthX[index] > 1000)
          this.someNpc.Add(this.Game.CreateNpc(this.npcIDs, this.birthX[index], 171, 1, -1, config));
        else
          this.someNpc.Add(this.Game.CreateNpc(this.npcIDs2, this.birthX[index], 171, 1, 1));
      }
    }
