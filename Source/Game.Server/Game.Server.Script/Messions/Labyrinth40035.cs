...
// Type: GameServerScript.AI.Messions.Labyrinth40035
    ...
    public override void OnStartGame()
    {
      ...
      for (int index = 0; index < this.birthX.Length; ++index)
      {
        if (this.birthX[index] > 1000)
          this.someNpc.Add(this.Game.CreateNpc(this.npcIDs, this.birthX[index], 534, 1, -1));
        else
          this.someNpc.Add(this.Game.CreateNpc(this.npcIDs2, this.birthX[index], 534, 1, -1));
      }
    }
