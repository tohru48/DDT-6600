...
// Type: GameServerScript.AI.Messions.furiaselvagem3DIFICIL
...
{
  public class furiaselvagem3DIFICIL : AMissionControl
  {
    private List<SimpleBoss> someBoss = new List<SimpleBoss>();
    private int bossID = 654325;
    private int bossID2 = 654326;
