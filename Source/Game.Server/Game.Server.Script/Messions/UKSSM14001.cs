...
// Type: GameServerScript.AI.Messions.UKSSM14001
...
{
  public class UKSSM14001 : AMissionControl
  {
    ...
    private int redNpcID = 14001;
    private int blueNpcID = 14002;
    ...
    public override void OnNewTurnStarted()
    {
      ...
      if (this.Game.TurnIndex <= 1 || this.Game.CurrentPlayer.Delay <= this.Game.PveGameDelay || this.blueCount == 3 && this.redCount == 12)
        return;
      ...
      else if (this.redCount < 12)
      {
        ...
        {
          for (int index = 0; index < 12 - this.redCount; ++index)
          {
            if (this.redTotalCount < 20 && this.redCount != 12)
            {
              ++this.redTotalCount;
