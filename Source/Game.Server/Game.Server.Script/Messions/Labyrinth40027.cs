...
// Type: GameServerScript.AI.Messions.Labyrinth40027
  ...
  public class Labyrinth40027 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      for (int index = 0; index < this.birthX.Length; ++index)
        this.someNpc.Add(this.Game.CreateNpc(this.npcIDs, this.birthX[index], 620, 1, -1));
    }
