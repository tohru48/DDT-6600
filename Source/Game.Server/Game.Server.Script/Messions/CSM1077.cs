...
// Type: GameServerScript.AI.Messions.CSM1077
...
namespace GameServerScript.AI.Messions
{
  public class CSM1077 : AMissionControl
  {
    ...
    public override void DoOther()
    {
      ...
      if (this.m_king == null)
        return;
      int index = this.Game.Random.Next(0, CSM1077.KillChat.Length);
      this.m_king.Say(CSM1077.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (!this.m_king.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, CSM1077.ShootedChat.Length);
      this.m_king.Say(CSM1077.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
