...
// Type: GameServerScript.AI.Messions.ETT3304
  ...
  public class ETT3304 : AMissionControl
  {
    ...
    public override bool CanGameOver()
    {
      ...
      if (this.m_state == this.secondBossID && this.m_secondKing == null)
      {
        ...
        this.king.FallFrom(this.king.X, this.king.Y, "fall", 0, 0, 5000, (LivingCallBack) null);
        ...
        this.m_secondKing.AddDelay(num - 1000);
        this.turn = this.Game.TurnIndex;
      }
