...
// Type: GameServerScript.AI.Messions.DLN5104
...
namespace GameServerScript.AI.Messions
{
  public class DLN5104 : AMissionControl
  {
    ...
    {
      base.DoOther();
      int index = this.Game.Random.Next(0, DLN5104.KillChat.Length);
      this.m_king.Say(DLN5104.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (!this.m_king.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, DLN5104.ShootedChat.Length);
      this.m_king.Say(DLN5104.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
