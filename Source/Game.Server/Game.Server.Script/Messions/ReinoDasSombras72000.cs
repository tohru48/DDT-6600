...
// Type: GameServerScript.AI.Messions.ReinoDasSombras72000
...
{
  public class ReinoDasSombras72000 : AMissionControl
  {
    private List<SimpleBoss> someBoss = new List<SimpleBoss>();
    private int bossID = 74010;
    ...
    public override void OnStartGame()
    {
      ...
      SimpleBoss boss = this.Game.CreateBoss(this.bossID, 1400, -1381, -1, 1, "");
