...
// Type: GameServerScript.AI.Messions.DCT4303
...
namespace GameServerScript.AI.Messions
{
  public class DCT4303 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.LoadResources(new int[4]
      {
        this.firstBossID,
        this.secondBossID,
        this.npcID,
    ...
    public override void OnStartGame()
    {
      ...
      this.m_king.FallFrom(this.m_king.X, this.m_king.Y, (string) null, 0, 0, 5000, (LivingCallBack) null);
      this.m_king.SetRelateDemagemRect(-41, -187, 83, 140);
      this.m_king.AddDelay(10);
      this.m_king.Say("Ngọn lửa câm giận<br/>đang sôi sục ...!", 0, 3500);
      this.m_king.PlayMovie("in", 0, 2500);
    ...
    public override void DoOther()
    {
      ...
      {
        int index = this.Game.Random.Next(0, DCT4303.KillChat.Length);
        this.m_king.Say(DCT4303.KillChat[index], 0, 0);
      }
      else
      {
        int index = this.Game.Random.Next(0, DCT4303.KillChat.Length);
    ...
    public override void OnShooted()
    {
      ...
      if (this.m_king.IsLiving)
      {
        int index = this.Game.Random.Next(0, DCT4303.ShootedChat.Length);
        this.m_king.Say(DCT4303.ShootedChat[index], 0, 1500);
      }
      else
      {
        int index = this.Game.Random.Next(0, DCT4303.ShootedChat.Length);
        this.m_secondKing.Say(DCT4303.ShootedChat[index], 0, 1500);
      }
      this.IsSay = 1;
    }
  }
