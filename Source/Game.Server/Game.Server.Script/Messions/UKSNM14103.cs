...
// Type: GameServerScript.AI.Messions.UKSNM14103
...
{
  public class UKSNM14103 : AMissionControl
  {
    ...
    private int m_state = 14106;
    private int turn = 0;
    private int IsSay = 0;
    private int firstBossID = 14106;
    private int secondBossID = 14107;
    ...
    public override bool CanGameOver()
    {
      ...
      if (this.m_state == this.secondBossID && this.m_secondKing == null)
      {
        ...
        this.m_secondKing.Say(LanguageMgr.GetTranslation("Você acabo com tudo não tem mais volta, agora estou irritado...vocês terão que sofrer pelo ato."), 0, 3000);
    ...
    public override void DoOther()
    {
      ...
      {
        int index = this.Game.Random.Next(0, UKSNM14103.KillChat.Length);
        this.m_king.Say(UKSNM14103.KillChat[index], 0, 0);
      }
      else
      {
        int index = this.Game.Random.Next(0, UKSNM14103.KillChat.Length);
    ...
    public override void OnShooted()
    {
      ...
      if (this.m_king.IsLiving)
      {
        int index = this.Game.Random.Next(0, UKSNM14103.ShootedChat.Length);
        this.m_king.Say(UKSNM14103.ShootedChat[index], 0, 1500);
      }
      else
      {
        int index = this.Game.Random.Next(0, UKSNM14103.ShootedChat.Length);
        this.m_secondKing.Say(UKSNM14103.ShootedChat[index], 0, 1500);
      }
      this.IsSay = 1;
    }
  }
