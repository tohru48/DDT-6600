...
// Type: GameServerScript.AI.Messions.ETT3303
...
namespace GameServerScript.AI.Messions
{
  public class ETT3303 : AMissionControl
  {
    ...
    public override void DoOther()
    {
      ...
      {
        int index = this.Game.Random.Next(0, ETT3303.KillChat.Length);
        this.m_king.Say(ETT3303.KillChat[index], 0, 0);
        this.boss.Say(ETT3303.KillChat[index], 0, 0);
      }
      else
      {
        int index = this.Game.Random.Next(0, ETT3303.KillChat.Length);
    ...
    public override void OnShooted()
    {
      ...
      if (this.m_king.IsLiving)
      {
        int index = this.Game.Random.Next(0, ETT3303.ShootedChat.Length);
        this.m_king.Say(ETT3303.ShootedChat[index], 0, 1500);
        this.boss.Say(ETT3303.ShootedChat[index], 0, 1500);
      }
      else
      {
        int index = this.Game.Random.Next(0, ETT3303.ShootedChat.Length);
