...
// Type: GameServerScript.AI.Messions.RRCS7001
...
namespace GameServerScript.AI.Messions
{
  public class RRCS7001 : AMissionControl
  {
    ...
    {
      base.OnStartGame();
      this.Game.IsBossWar = "7001";
      if (this.m_layer == null)
        this.m_layer = (PhysicalObj) this.Game.Createlayer(1197, 957, "hide", "game.living.Living176", "in", 1, -2);
