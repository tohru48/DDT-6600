...
// Type: GameServerScript.AI.Messions.WAEpic13404
...
namespace GameServerScript.AI.Messions
{
  public class WAEpic13404 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      SimpleBoss boss1 = this.Game.CreateBoss(this.bossID, 100, 990, 1, 1, "");
      ...
      SimpleBoss boss2 = this.Game.CreateBoss(this.bossID2, 1890, 990, -1, 1, "");
