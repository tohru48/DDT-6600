...
// Type: GameServerScript.AI.Messions.GON6104
...
namespace GameServerScript.AI.Messions
{
  public class GON6104 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(2, "image/game/effect/6/chang.swf", "asset.game.six.chang");
      this.Game.AddLoadingFile(2, "image/game/effect/6/popcan.swf", "asset.game.six.popcan");
      int[] npcIds = new int[1]{ this.bossID };
      this.Game.LoadResources(npcIds);
      this.Game.LoadNpcGameOverResources(npcIds);
      this.Game.SetMap(1168);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.m_boss = this.Game.CreateBoss(this.bossID, 1250, 950, -1, 1, "");
      ...
      this.m_boss.PlayMovie("shengqi", 1000, 2000);
      this.m_boss.PlayMovie("xialai", 2000, 3000);
    }
