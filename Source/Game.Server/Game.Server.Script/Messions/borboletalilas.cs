...
// Type: GameServerScript.AI.Messions.borboletalilas
...
{
  public class borboletalilas : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private int bossID = 83171;
    private int kill = 0;
    ...
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 1267, 57, -1, 4, "");
