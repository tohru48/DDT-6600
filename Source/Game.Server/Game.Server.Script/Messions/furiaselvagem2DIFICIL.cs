...
// Type: GameServerScript.AI.Messions.furiaselvagem2DIFICIL
...
{
  public class furiaselvagem2DIFICIL : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private SimpleBoss m_king = (SimpleBoss) null;
    private int bossID = 654323;
    private int bossID2 = 654324;
    private int kill = 0;
    ...
    public override void OnStartGame()
    {
      ...
      this.boss = this.Game.CreateBoss(this.bossID, 121, 516, -1, 1, "");
      this.m_king = this.Game.CreateBoss(this.bossID2, 1827, 597, -1, 1, "");
