...
// Type: GameServerScript.AI.Messions.CSM1078
...
namespace GameServerScript.AI.Messions
{
  public class CSM1078 : AMissionControl
  {
    ...
    public override void DoOther()
    {
      ...
      if (this.m_king == null)
        return;
      int index = this.Game.Random.Next(0, CSM1078.KillChat.Length);
      this.m_king.Say(CSM1078.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (!this.m_king.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, CSM1078.ShootedChat.Length);
      this.m_king.Say(CSM1078.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
