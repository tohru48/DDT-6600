...
// Type: GameServerScript.AI.Messions.RecantoDasTrevas26665
...
{
  public class RecantoDasTrevas26665 : AMissionControl
  {
    private List<SimpleBoss> someBoss = new List<SimpleBoss>();
    private int bossID = 71006;
    private int bossID2 = 71007;
    private SimpleNpc npclobo = (SimpleNpc) null;
    private int kill = 0;
    private int npcID = 240300;
    ...
    public override void OnStartGame()
    {
      ...
      SimpleBoss boss1 = this.Game.CreateBoss(this.bossID2, 1494, -1381, -1, 1, "");
      ...
      SimpleBoss boss2 = this.Game.CreateBoss(this.bossID, 303, -1381, -1, 1, "");
