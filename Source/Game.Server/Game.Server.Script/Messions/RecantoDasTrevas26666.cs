...
// Type: GameServerScript.AI.Messions.RecantoDasTrevas26666
...
{
  public class RecantoDasTrevas26666 : AMissionControl
  {
    ...
    {
      base.OnStartGame();
      this.Game.IsBossWar = "73000";
      this.m_king = this.Game.CreateBoss(this.bossID, 303, -1381, -1, 1, "");
