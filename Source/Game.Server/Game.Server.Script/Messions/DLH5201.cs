...
// Type: GameServerScript.AI.Messions.DLH5201
...
namespace GameServerScript.AI.Messions
{
  public class DLH5201 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      this.moive = (PhysicalObj) this.Game.Createlayer(1567, 810, "moive", "asset.game.4.jinqud", "out", 1, 1);
      this.m_boss = this.Game.CreateBoss(this.bossID2, 190, 365, 1, 1, "");
      this.boss = this.Game.CreateBoss(this.bossID, 1477, 768, -1, 0, "NoBlood");
