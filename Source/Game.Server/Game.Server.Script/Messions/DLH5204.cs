...
// Type: GameServerScript.AI.Messions.DLH5204
...
namespace GameServerScript.AI.Messions
{
  public class DLH5204 : AMissionControl
  {
    ...
    public override void DoOther()
    {
      ...
      if (this.m_king == null)
        return;
      int index = this.Game.Random.Next(0, DLH5204.KillChat.Length);
      this.m_king.Say(DLH5204.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (!this.m_king.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, DLH5204.ShootedChat.Length);
      this.m_king.Say(DLH5204.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
