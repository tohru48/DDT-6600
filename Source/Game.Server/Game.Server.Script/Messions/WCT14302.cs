...
// Type: GameServerScript.AI.Messions.WCT14302
...
{
  public class WCT14302 : AMissionControl
  {
    private SimpleNpc goal = (SimpleNpc) null;
    private SimpleBoss boss = (SimpleBoss) null;
    private int npcID = 14203;
    private int chillID = 14204;
    private int bossID = 14205;
