...
// Type: GameServerScript.AI.Messions.CHM1276
...
namespace GameServerScript.AI.Messions
{
  public class CHM1276 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      this.m_king.Say("你们这些低等的庶民，竟敢来到我的王国放肆！", 3000, 0);
    ...
    public override bool CanGameOver()
    {
      ...
      {
        this.m_secondKing = this.Game.CreateBoss(this.m_state, this.m_king.X, this.m_king.Y, this.m_king.Direction, 4, "");
