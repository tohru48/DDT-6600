...
// Type: GameServerScript.AI.Messions.Labyrinth40015
  ...
  public class Labyrinth40015 : AMissionControl
  {
    ...
    public override void OnStartGame()
    {
      ...
      for (int index = 0; index < this.birthX.Length; ++index)
        this.someNpc.Add(this.Game.CreateNpc(this.npcIDs, this.birthX[index], 404, 1, -1, config));
    }
