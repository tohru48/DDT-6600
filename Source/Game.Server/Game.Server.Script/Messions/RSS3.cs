...
// Type: GameServerScript.AI.Messions.RSS3
...
{
  public class RSS3 : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private int npcID = 24020;
    private int bossID = 74019;
    private int kill = 0;
    ...
    public override void OnStartGame()
    {
      ...
      this.boss = this.Game.CreateBoss(this.bossID, 900, 380, -1, 1, "");
