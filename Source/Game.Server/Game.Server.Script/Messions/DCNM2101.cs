...
// Type: GameServerScript.AI.Messions.DCNM2101
...
namespace GameServerScript.AI.Messions
{
  public class DCNM2101 : AMissionControl
  {
    ...
    private int[] npcIDs = new int[2]{ 2101, 2102 };
    ...
    {
      base.OnStartGame();
      this.Game.IsBossWar = "2101";
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 52, 506, 1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 100, 507, 1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 155, 508, 1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 210, 507, 1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 253, 507, 1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1275, 508, 1, -1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1325, 506, 1, -1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1360, 508, 1, -1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1410, 506, 1, -1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1475, 508, 1, -1));
    }
