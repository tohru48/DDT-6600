...
// Type: GameServerScript.AI.Messions.TemplarCastle151
...
{
  public class TemplarCastle151 : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private int bossID = 21;
    private int kill = 0;
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.SetMap(12014);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 974, 200, -1, 4, "");
