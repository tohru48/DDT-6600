...
// Type: GameServerScript.AI.Messions.baleiaassasina1
...
{
  public class baleiaassasina1 : AMissionControl
  {
    private List<SimpleNpc> someNpc = new List<SimpleNpc>();
    private int dieRedCount = 0;
    private int[] npcIDs = new int[3]{ 88887, 88888, 88888 };
