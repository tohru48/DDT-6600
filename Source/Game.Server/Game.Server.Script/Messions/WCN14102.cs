...
// Type: GameServerScript.AI.Messions.WCN14102
...
{
  public class WCN14102 : AMissionControl
  {
    private SimpleNpc goal = (SimpleNpc) null;
    private SimpleBoss boss = (SimpleBoss) null;
    private int npcID = 14003;
    private int chillID = 14004;
    private int bossID = 14005;
