...
// Type: GameServerScript.AI.Messions.CHM1273
  ...
  public class CHM1273 : AMissionControl
  {
    ...
    public override void OnNewTurnStarted()
    {
      ...
      foreach (Living allFightPlayer in this.Game.GetAllFightPlayers())
        allFightPlayer.AfterKilledByLiving += new KillLivingEventHanlde(this.OnKillPlayer);
      this.IsSay = 0;
    }
    ...
    public void OnKillPlayer(Living living, Living target, int damageAmount, int criticalAmount)
    {
      if (this.m_boss == null)
        return;
      int index = this.Game.Random.Next(0, CHM1273.KillChat.Length);
      this.m_boss.Say(CHM1273.KillChat[index], 0, 0);
    }
    ...
    public override void OnShooted()
    {
      if (this.m_boss == null || !this.m_boss.IsLiving || this.IsSay != 0)
        return;
      int index = this.Game.Random.Next(0, CHM1273.ShootedChat.Length);
      this.m_boss.Say(CHM1273.ShootedChat[index], 0, 1500);
      this.IsSay = 1;
    }
  }
}
