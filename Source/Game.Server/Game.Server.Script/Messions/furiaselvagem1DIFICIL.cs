...
// Type: GameServerScript.AI.Messions.furiaselvagem1DIFICIL
...
{
  public class furiaselvagem1DIFICIL : AMissionControl
  {
    private List<SimpleNpc> someNpc = new List<SimpleNpc>();
    private int dieRedCount = 0;
    private int[] npcIDs = new int[3]
    {
      654321,
      654322,
      654321
    ...
    public override void OnStartGame()
    {
      ...
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1560, 861, -1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1620, 861, -1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1700, 861, -1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1785, 861, -1, 1));
      this.someNpc.Add(this.Game.CreateNpc(this.npcIDs[this.Game.Random.Next(0, this.npcIDs.Length)], 1847, 847, -1, 1));
    }
