...
// Type: GameServerScript.AI.Messions.UKSHM14303
...
{
  public class UKSHM14303 : AMissionControl
  {
    ...
    private int m_state = 14306;
    private int turn = 0;
    private int IsSay = 0;
    private int firstBossID = 14306;
    private int secondBossID = 14307;
    private int npcID = 14308;
    ...
    public override void DoOther()
    {
      ...
      {
        int index = this.Game.Random.Next(0, UKSHM14303.KillChat.Length);
        this.m_king.Say(UKSHM14303.KillChat[index], 0, 0);
      }
      else
      {
        int index = this.Game.Random.Next(0, UKSHM14303.KillChat.Length);
    ...
    public override void OnShooted()
    {
      ...
      if (this.m_king.IsLiving)
      {
        int index = this.Game.Random.Next(0, UKSHM14303.ShootedChat.Length);
        this.m_king.Say(UKSHM14303.ShootedChat[index], 0, 1500);
      }
      else
      {
        int index = this.Game.Random.Next(0, UKSHM14303.ShootedChat.Length);
        this.m_secondKing.Say(UKSHM14303.ShootedChat[index], 0, 1500);
      }
      this.IsSay = 1;
    }
  }
