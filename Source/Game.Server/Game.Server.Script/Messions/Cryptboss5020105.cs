...
// Type: GameServerScript.AI.Messions.Cryptboss5020105
...
namespace GameServerScript.AI.Messions
{
  public class Cryptboss5020105 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(2, "image/game/effect/11/064.swf", "asset.game.eleven.064");
      this.Game.SetMap(1511);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 796, 526, -1, 1, "");
    ...
    public override void OnGameOver()
    {
      ...
      foreach (Player allFightPlayer in this.Game.GetAllFightPlayers())
        allFightPlayer.PlayerDetail.UpdatePveResult("cryotboss", 1, this.Game.IsWin);
    }
  }
}
