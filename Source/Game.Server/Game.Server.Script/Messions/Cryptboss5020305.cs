...
// Type: GameServerScript.AI.Messions.Cryptboss5020305
...
namespace GameServerScript.AI.Messions
{
  public class Cryptboss5020305 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(1, "bombs/13.swf", "tank.resource.bombs.Bomb13");
      this.Game.SetMap(1513);
    }

    public override void OnStartGame()
    {
      base.OnStartGame();
      this.boss = this.Game.CreateBoss(this.bossID, 796, 186, -1, 1, "");
    ...
    public override void OnGameOver()
    {
      ...
      foreach (Player allFightPlayer in this.Game.GetAllFightPlayers())
        allFightPlayer.PlayerDetail.UpdatePveResult("cryotboss", 3, this.Game.IsWin);
    }
  }
}
