...
// Type: GameServerScript.AI.Messions.furiaselvagem2NORMAL
...
{
  public class furiaselvagem2NORMAL : AMissionControl
  {
    private SimpleBoss boss = (SimpleBoss) null;
    private SimpleBoss m_king = (SimpleBoss) null;
    private int bossID = 284173;
    private int bossID2 = 284174;
    private int kill = 0;
