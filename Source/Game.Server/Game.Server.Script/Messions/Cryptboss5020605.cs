...
// Type: GameServerScript.AI.Messions.Cryptboss5020605
...
namespace GameServerScript.AI.Messions
{
  public class Cryptboss5020605 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(2, "image/game/effect/11/226a.swf", "asset.game.eleven.226a");
      this.Game.AddLoadingFile(2, "image/game/effect/11/226b.swf", "asset.game.eleven.226b");
      this.Game.SetMap(1516);
    }
    ...
    public override void OnStartGame()
    {
      ...
      config.IsFly = true;
      this.boss = this.Game.CreateBoss(this.bossID, 796, 488, -1, 1, "", config);
    ...
    public override void OnGameOver()
    {
      ...
      foreach (Player allFightPlayer in this.Game.GetAllFightPlayers())
        allFightPlayer.PlayerDetail.UpdatePveResult("cryotboss", 6, this.Game.IsWin);
    }
  }
}
