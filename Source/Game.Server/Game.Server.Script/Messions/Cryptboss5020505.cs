...
// Type: GameServerScript.AI.Messions.Cryptboss5020505
...
namespace GameServerScript.AI.Messions
{
  public class Cryptboss5020505 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      this.Game.AddLoadingFile(2, "image/game/effect/11/057.swf", "asset.game.eleven.057");
      this.Game.SetMap(1515);
    }
    ...
    public override void OnGameOver()
    {
      ...
      foreach (Player allFightPlayer in this.Game.GetAllFightPlayers())
        allFightPlayer.PlayerDetail.UpdatePveResult("cryotboss", 5, this.Game.IsWin);
    }
  }
}
