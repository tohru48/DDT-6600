...
// Type: GameServerScript.AI.NPC.UKTerrorFastLastHardGame
...
{
  public class UKTerrorFastLastHardGame : ABrain
  {
    private int m_attackTurn = 0;
    private int npcID = 14205;
    ...
    {
      int index = this.Game.Random.Next(0, UKTerrorFastLastHardGame.BeatOneKillChat.Length);
      this.Body.Say(UKTerrorFastLastHardGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
