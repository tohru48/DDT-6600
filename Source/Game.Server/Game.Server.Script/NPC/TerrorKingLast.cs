...
// Type: GameServerScript.AI.NPC.TerrorKingLast
...
namespace GameServerScript.AI.NPC
{
  public class TerrorKingLast : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, TerrorKingLast.SealChat.Length);
      this.Body.Say(TerrorKingLast.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, TerrorKingLast.CallChat.Length);
      this.Body.Say(TerrorKingLast.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, TerrorKingLast.SealChat.Length);
      this.Body.Say(TerrorKingLast.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, TerrorKingLast.AngryChat.Length);
      this.Body.Say(TerrorKingLast.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, TerrorKingLast.KillAttackChat.Length);
      this.Body.Say(TerrorKingLast.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
