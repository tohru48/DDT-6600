...
// Type: GameServerScript.AI.NPC.furiatotal
...
{
  public class furiatotal : ABrain
  {
    private int m_attackTurn = 0;
    private int npcID = 123457;
    ...
    {
      int index = this.Game.Random.Next(0, furiatotal.BeatOneKillChat.Length);
      this.Body.Say(furiatotal.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
