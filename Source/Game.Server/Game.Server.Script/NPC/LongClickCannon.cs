...
// Type: GameServerScript.AI.NPC.LongClickCannon
...
namespace GameServerScript.AI.NPC
{
  public class LongClickCannon : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, LongClickCannon.KillAttackChat.Length);
      if (this.m_turn == 0)
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(LongClickCannon.KillAttackChat[index], 1, 13000);
      ...
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(LongClickCannon.KillAttackChat[index], 1, 0);
        this.Body.PlayMovie("beat1", 2000, 0);
        this.Body.RangeAttacking(fx, tx, "cry", 4000, (List<Player>) null);
      }
    }

    private void ToA() => this.Body.PlayMovie("toA", 1000, 4000);
