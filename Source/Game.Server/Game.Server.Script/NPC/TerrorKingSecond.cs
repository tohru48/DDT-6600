...
// Type: GameServerScript.AI.NPC.TerrorKingSecond
...
namespace GameServerScript.AI.NPC
{
  public class TerrorKingSecond : ABrain
  {
    ...
    {
      this.Body.MoveTo(this.Game.Random.Next(840, 900), this.Body.Y, "walk", 0, "", ((SimpleBoss) this.Body).NpcInfo.speed, new LivingCallBack(this.NextAttack));
    }
    ...
    private void AllAttack()
    {
      ...
      if (this.m_turn == 0)
      {
        int index = this.Game.Random.Next(0, TerrorKingSecond.AllAttackChat.Length);
        this.Body.Say(TerrorKingSecond.AllAttackChat[index], 1, 13000);
      ...
      {
        int index = this.Game.Random.Next(0, TerrorKingSecond.AllAttackChat.Length);
        this.Body.Say(TerrorKingSecond.AllAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, TerrorKingSecond.KillAttackChat.Length);
      if (this.m_turn == 0)
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(TerrorKingSecond.KillAttackChat[index], 1, 13000);
        this.Body.PlayMovie("beat1", 15000, 0);
      ...
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(TerrorKingSecond.KillAttackChat[index], 1, 0);
    ...
    private void ProtectingWall()
    {
      ...
      int index = this.Game.Random.Next(0, TerrorKingSecond.WallChat.Length);
      this.Body.Say(TerrorKingSecond.WallChat[index], 1, 0);
    }
    ...
    private void NextAttack()
    {
      ...
      for (int index1 = 0; index1 < num; ++index1)
      {
        ...
        int index2 = this.Game.Random.Next(0, TerrorKingSecond.ShootChat.Length);
        this.Body.Say(TerrorKingSecond.ShootChat[index2], 1, 0);
