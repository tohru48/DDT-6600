...
// Type: GameServerScript.AI.NPC.ThirteenSimpleDevilBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleDevilBoss : ABrain
  {
    ...
    private void CallHopquaidi()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleDevilBoss.ShootChat.Length);
      this.Body.Say(ThirteenSimpleDevilBoss.ShootChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleDevilBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenSimpleDevilBoss.AddBooldChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleDevilBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleDevilBoss.KillAttackChat[index], 1, 1000);
