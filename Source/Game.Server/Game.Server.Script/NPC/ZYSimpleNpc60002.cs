...
// Type: GameServerScript.AI.NPC.ZYSimpleNpc60002
...
namespace GameServerScript.AI.NPC
{
  public class ZYSimpleNpc60002 : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60002.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60002.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60002.CallChat.Length);
      this.Body.Say(ZYSimpleNpc60002.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60002.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60002.SealChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60002.KillAttackChat.Length);
      this.Body.Say(ZYSimpleNpc60002.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
