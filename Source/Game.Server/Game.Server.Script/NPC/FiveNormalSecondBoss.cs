...
// Type: GameServerScript.AI.NPC.FiveNormalSecondBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalSecondBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveNormalSecondBoss.KillAttackChat.Length);
      if (this.m_turn == 0)
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(FiveNormalSecondBoss.KillAttackChat[index], 1, 13000);
      ...
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(FiveNormalSecondBoss.KillAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, FiveNormalSecondBoss.AllAttackChat.Length);
      this.Body.Say(FiveNormalSecondBoss.AllAttackChat[index], 1, 0);
