...
// Type: GameServerScript.AI.NPC.ThirteenSimpleBrynBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleBrynBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleBrynBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleBrynBoss.KillAttackChat[index], 1, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleBrynBoss.ShootChat.Length);
      this.Body.Say(ThirteenSimpleBrynBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleBrynBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenSimpleBrynBoss.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnShootedSay()
    {
      int index1 = this.Game.Random.Next(0, ThirteenSimpleBrynBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenSimpleBrynBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenSimpleBrynBoss.DiedChat.Length);
      this.Body.Say(ThirteenSimpleBrynBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
