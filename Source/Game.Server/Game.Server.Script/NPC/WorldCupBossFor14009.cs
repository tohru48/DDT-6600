...
// Type: GameServerScript.AI.NPC.WorldCupBossFor14009
...
{
  public class WorldCupBossFor14009 : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, WorldCupBossFor14009.KillAttackChat.Length);
      this.Body.Say(WorldCupBossFor14009.KillAttackChat[index], 1, 1000);
    ...
    private void AttackA(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, WorldCupBossFor14009.ShootChat.Length);
      this.Body.Say(WorldCupBossFor14009.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, WorldCupBossFor14009.KillPlayerChat.Length);
      this.Body.Say(WorldCupBossFor14009.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnShootedSay()
    {
      int index1 = this.Game.Random.Next(0, WorldCupBossFor14009.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(WorldCupBossFor14009.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, WorldCupBossFor14009.DiedChat.Length);
      this.Body.Say(WorldCupBossFor14009.DiedChat[index2], 1, 100, 2000);
    }
  }
}
