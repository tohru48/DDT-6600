...
// Type: GameServerScript.AI.NPC.ThirteenNormalNioBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalNioBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalNioBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalNioBoss.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalNioBoss.AllAttackChat.Length);
      this.Body.Say(ThirteenNormalNioBoss.AllAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenNormalNioBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenNormalNioBoss.AddBooldChat[index], 1, 0);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalNioBoss.ShootChat.Length);
      this.Body.Say(ThirteenNormalNioBoss.ShootChat[index], 1, 0);
