...
// Type: GameServerScript.AI.NPC.UKTerrorFastLastGame
...
{
  public class UKTerrorFastLastGame : ABrain
  {
    private int m_attackTurn = 0;
    private int npcID = 14005;
    ...
    {
      int index = this.Game.Random.Next(0, UKTerrorFastLastGame.BeatOneKillChat.Length);
      this.Body.Say(UKTerrorFastLastGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
