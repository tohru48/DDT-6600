...
// Type: GameServerScript.AI.NPC.ThirteenHardFourthBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenHardFourthBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenHardFourthBoss.AngryChat.Length);
      this.Body.Say(ThirteenHardFourthBoss.AngryChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenHardFourthBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenHardFourthBoss.KillAttackChat[index], 1, 500);
