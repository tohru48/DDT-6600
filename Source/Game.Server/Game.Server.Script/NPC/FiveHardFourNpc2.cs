...
// Type: GameServerScript.AI.NPC.FiveHardFourNpc2
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardFourNpc2 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveHardFourNpc2.KillAttackChat.Length);
      this.Body.Say(FiveHardFourNpc2.KillAttackChat[index], 1, 1000);
