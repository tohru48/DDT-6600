...
// Type: GameServerScript.AI.NPC.SeventhSimpleHouseAi
...
namespace GameServerScript.AI.NPC
{
  public class SeventhSimpleHouseAi : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, SeventhSimpleHouseAi.KillAttackChat.Length);
      this.Body.Say(SeventhSimpleHouseAi.KillAttackChat[index], 1, 1000);
