...
// Type: GameServerScript.AI.NPC.ThirdTerrorKingThird
...
namespace GameServerScript.AI.NPC
{
  public class ThirdTerrorKingThird : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingThird.SealChat.Length);
      this.Body.Say(ThirdTerrorKingThird.AllAttackChat[index], 1, 500);
    ...
    private void NextAttack()
    {
      ...
      if (this.Body.ShootPoint(randomPlayer3.X, randomPlayer3.Y, 54, 1000, 10000, 1, 1.5f, 6550))
        this.Body.PlayMovie("beatA", 5700, 0);
    }

    public void Summon()
    {
      int index = this.Game.Random.Next(0, ThirdTerrorKingThird.CallChat.Length);
      this.Body.Say(ThirdTerrorKingThird.CallChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingThird.KillAttackChat.Length);
      this.Body.Say(ThirdTerrorKingThird.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatC", 2500, 0);
