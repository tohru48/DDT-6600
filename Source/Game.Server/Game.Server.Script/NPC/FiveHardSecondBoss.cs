...
// Type: GameServerScript.AI.NPC.FiveHardSecondBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardSecondBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveHardSecondBoss.KillAttackChat.Length);
      if (this.m_turn == 0)
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(FiveHardSecondBoss.KillAttackChat[index], 1, 13000);
      ...
      {
        this.Body.CurrentDamagePlus = 10f;
        this.Body.Say(FiveHardSecondBoss.KillAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, FiveHardSecondBoss.AllAttackChat.Length);
      this.Body.Say(FiveHardSecondBoss.AllAttackChat[index], 1, 0);
