...
// Type: GameServerScript.AI.NPC.ThirteenNormalDevilBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalDevilBoss : ABrain
  {
    ...
    private void CallHopquaidi()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalDevilBoss.ShootChat.Length);
      this.Body.Say(ThirteenNormalDevilBoss.ShootChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenNormalDevilBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenNormalDevilBoss.AddBooldChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalDevilBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalDevilBoss.KillAttackChat[index], 1, 1000);
