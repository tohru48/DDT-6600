...
// Type: GameServerScript.AI.NPC.ThirteenTerrorAntBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenTerrorAntBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorAntBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenTerrorAntBoss.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenTerrorAntBoss.KillPlayerChat[index], 1, 0);
    ...
    private void Plain()
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorAntBoss.ShootChat.Length);
      this.Body.Say(ThirteenTerrorAntBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenTerrorAntBoss.KillPlayerChat[index], 1, 0, 2000);
    }
    ...
    {
      int index1 = this.Game.Random.Next(0, ThirteenTerrorAntBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenTerrorAntBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenTerrorAntBoss.DiedChat.Length);
      this.Body.Say(ThirteenTerrorAntBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
