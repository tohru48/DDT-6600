...
// Type: GameServerScript.AI.NPC.ThirteenHardShadowBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenHardShadowBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenHardShadowBoss.AngryChat.Length);
      this.Body.Say(ThirteenHardShadowBoss.AngryChat[index], 1, 0);
    ...
    {
      this.Body.CurrentDamagePlus = 10f;
      int index = this.Game.Random.Next(0, ThirteenHardShadowBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenHardShadowBoss.KillAttackChat[index], 1, 500);
