...
// Type: GameServerScript.AI.NPC.ThirteenSimpleThirdBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleThirdBoss : ABrain
  {
    ...
    public void CallNiutou() => this.Game.FindRandomPlayer();
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, ThirteenSimpleThirdBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleThirdBoss.KillAttackChat[index], 1, 1000);
