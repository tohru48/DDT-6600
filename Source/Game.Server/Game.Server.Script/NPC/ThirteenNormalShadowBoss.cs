...
// Type: GameServerScript.AI.NPC.ThirteenNormalShadowBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalShadowBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenNormalShadowBoss.AngryChat.Length);
      this.Body.Say(ThirteenNormalShadowBoss.AngryChat[index], 1, 0);
    ...
    {
      this.Body.CurrentDamagePlus = 10f;
      int index = this.Game.Random.Next(0, ThirteenNormalShadowBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalShadowBoss.KillAttackChat[index], 1, 500);
