...
// Type: GameServerScript.AI.NPC.TerrorCaptainAi
...
namespace GameServerScript.AI.NPC
{
  public class TerrorCaptainAi : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, TerrorCaptainAi.KillAttackChat.Length);
      this.Body.Say(TerrorCaptainAi.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, TerrorCaptainAi.AllAttackChat.Length);
      this.Body.Say(TerrorCaptainAi.AllAttackChat[index], 1, 0);
    ...
    {
      this.ChangeDirection(3);
      int index = this.Game.Random.Next(0, TerrorCaptainAi.ShootChat.Length);
      this.Body.Say(TerrorCaptainAi.ShootChat[index], 1, 0);
    ...
    private void Summon()
    {
      ...
      int index = this.Game.Random.Next(0, TerrorCaptainAi.CallChat.Length);
      this.Body.Say(TerrorCaptainAi.CallChat[index], 1, 3300);
