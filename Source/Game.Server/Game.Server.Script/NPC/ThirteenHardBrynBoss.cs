...
// Type: GameServerScript.AI.NPC.ThirteenHardBrynBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenHardBrynBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenHardBrynBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenHardBrynBoss.KillAttackChat[index], 1, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenHardBrynBoss.ShootChat.Length);
      this.Body.Say(ThirteenHardBrynBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenHardBrynBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenHardBrynBoss.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnShootedSay()
    {
      int index1 = this.Game.Random.Next(0, ThirteenHardBrynBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenHardBrynBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenHardBrynBoss.DiedChat.Length);
      this.Body.Say(ThirteenHardBrynBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
