...
// Type: GameServerScript.AI.NPC.FEBOSS
...
namespace GameServerScript.AI.NPC
{
  public class FEBOSS : ABrain
  {
    ...
    private void AttackC()
    {
      ...
      this.Body.PlayMovie("beatC", 1000, 2000);
      this.Body.CallFuction(new LivingCallBack(this.RangeAttacking), 3500);
    }

    private void AttackD()
    {
      this.Body.CallFuction(new LivingCallBack(this.AttackA), 1000);
      this.Body.CallFuction(new LivingCallBack(this.AttackB), 2000);
      this.Body.CallFuction(new LivingCallBack(this.AttackC), 3000);
      this.Body.CallFuction(new LivingCallBack(this.AttackC), 4000);
    }
