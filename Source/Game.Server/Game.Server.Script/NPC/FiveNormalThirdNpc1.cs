...
// Type: GameServerScript.AI.NPC.FiveNormalThirdNpc1
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalThirdNpc1 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveNormalThirdNpc1.KillAttackChat.Length);
      this.Body.Say(FiveNormalThirdNpc1.KillAttackChat[index], 1, 1000);
