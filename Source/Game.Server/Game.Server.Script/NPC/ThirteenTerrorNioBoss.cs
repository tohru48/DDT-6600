...
// Type: GameServerScript.AI.NPC.ThirteenTerrorNioBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenTerrorNioBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorNioBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenTerrorNioBoss.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorNioBoss.AllAttackChat.Length);
      this.Body.Say(ThirteenTerrorNioBoss.AllAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorNioBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenTerrorNioBoss.AddBooldChat[index], 1, 0);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorNioBoss.ShootChat.Length);
      this.Body.Say(ThirteenTerrorNioBoss.ShootChat[index], 1, 0);
