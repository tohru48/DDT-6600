...
// Type: GameServerScript.AI.NPC.FourHardHawkNpc
...
namespace GameServerScript.AI.NPC
{
  public class FourHardHawkNpc : ABrain
  {
    ...
    private void WalkA()
    {
      this.Body.MoveTo(this.Game.Random.Next(200, 1389), this.Body.Y, "fly", 3000, "", 12, new LivingCallBack(this.AllAttack));
    }
    ...
    {
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, FourHardHawkNpc.AllAttackChat.Length);
      this.Body.Say(FourHardHawkNpc.AllAttackChat[index], 1, 1000);
