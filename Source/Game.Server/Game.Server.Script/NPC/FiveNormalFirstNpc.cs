...
// Type: GameServerScript.AI.NPC.FiveNormalFirstNpc
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalFirstNpc : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveNormalFirstNpc.KillAttackChat.Length);
      this.Body.Say(FiveNormalFirstNpc.KillAttackChat[index], 1, 1000);
