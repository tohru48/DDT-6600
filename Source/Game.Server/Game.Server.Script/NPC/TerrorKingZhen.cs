...
// Type: GameServerScript.AI.NPC.TerrorKingZhen
...
namespace GameServerScript.AI.NPC
{
  public class TerrorKingZhen : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, TerrorKingZhen.SealChat.Length);
      this.Body.Say(TerrorKingZhen.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, TerrorKingZhen.CallChat.Length);
      this.Body.Say(TerrorKingZhen.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, TerrorKingZhen.SealChat.Length);
      this.Body.Say(TerrorKingZhen.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, TerrorKingZhen.AngryChat.Length);
      this.Body.Say(TerrorKingZhen.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void GoOnAngger()
    {
      ...
      else
      {
        ...
        this.Body.PlayMovie("cast", 2000, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, TerrorKingZhen.KillAttackChat.Length);
      this.Body.Say(TerrorKingZhen.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
