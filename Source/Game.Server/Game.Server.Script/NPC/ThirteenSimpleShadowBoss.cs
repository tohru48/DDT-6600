...
// Type: GameServerScript.AI.NPC.ThirteenSimpleShadowBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleShadowBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleShadowBoss.AngryChat.Length);
      this.Body.Say(ThirteenSimpleShadowBoss.AngryChat[index], 1, 0);
    ...
    {
      this.Body.CurrentDamagePlus = 10f;
      int index = this.Game.Random.Next(0, ThirteenSimpleShadowBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleShadowBoss.KillAttackChat[index], 1, 500);
