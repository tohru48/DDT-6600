...
// Type: GameServerScript.AI.NPC.ThirdHardKingSecond
...
namespace GameServerScript.AI.NPC
{
  public class ThirdHardKingSecond : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdHardKingSecond.KillAttackChat.Length);
      this.Body.Say(ThirdHardKingSecond.KillAttackChat[index], 1, 1000);
    ...
    private void Summon()
    {
      int index = this.Game.Random.Next(0, ThirdHardKingSecond.CallChat.Length);
      this.Body.Say(ThirdHardKingSecond.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdHardKingSecond.ShootChat.Length);
      this.Body.Say(ThirdHardKingSecond.ShootChat[index], 0, 0);
