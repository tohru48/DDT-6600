...
// Type: GameServerScript.AI.NPC.ThirteenTerrorBrynBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenTerrorBrynBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorBrynBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenTerrorBrynBoss.KillAttackChat[index], 1, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorBrynBoss.ShootChat.Length);
      this.Body.Say(ThirteenTerrorBrynBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorBrynBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenTerrorBrynBoss.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnShootedSay()
    {
      int index1 = this.Game.Random.Next(0, ThirteenTerrorBrynBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenTerrorBrynBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenTerrorBrynBoss.DiedChat.Length);
      this.Body.Say(ThirteenTerrorBrynBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
