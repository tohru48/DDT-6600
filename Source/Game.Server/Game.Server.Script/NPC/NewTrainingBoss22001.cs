...
// Type: GameServerScript.AI.NPC.NewTrainingBoss22001
...
namespace GameServerScript.AI.NPC
{
  public class NewTrainingBoss22001 : ABrain
  {
    ...
    {
      int num = this.Game.Random.Next(20, 50);
      int[] numArray = new int[2]{ 1, -1 };
      if (num > 30)
        this.Body.MoveTo(this.Body.X + num * numArray[1], this.Body.Y, "happy", 1000, "", ((SimpleBoss) this.Body).NpcInfo.speed, new LivingCallBack(this.NextAttack));
      else
        this.Body.MoveTo(this.Body.X + num * numArray[0], this.Body.Y, "happy", 1000, "", ((SimpleBoss) this.Body).NpcInfo.speed, new LivingCallBack(this.NextAttack));
    }
