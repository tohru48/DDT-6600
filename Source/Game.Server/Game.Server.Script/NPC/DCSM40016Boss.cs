...
// Type: GameServerScript.AI.NPC.DCSM40016Boss
...
namespace GameServerScript.AI.NPC
{
  public class DCSM40016Boss : ABrain
  {
    ...
    {
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      this.Body.MoveTo(850, 470, "fly", 1000, "", 16, new LivingCallBack(this.ChangeDirection));
    }
    ...
    private void CallHopquaidi()
    {
      ...
      int index = this.Game.Random.Next(0, DCSM40016Boss.ShootChat.Length);
      this.Body.Say(DCSM40016Boss.ShootChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, DCSM40016Boss.AddBooldChat.Length);
      this.Body.Say(DCSM40016Boss.AddBooldChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, DCSM40016Boss.KillAttackChat.Length);
      this.Body.Say(DCSM40016Boss.KillAttackChat[index], 1, 1000);
