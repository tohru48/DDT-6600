...
// Type: GameServerScript.AI.NPC.FourNormalCattleBoss
...
namespace GameServerScript.AI.NPC
{
  public class FourNormalCattleBoss : ABrain
  {
    ...
    private void Star()
    {
      int index = this.Game.Random.Next(0, FourNormalCattleBoss.CallChat.Length);
      this.Body.Say(FourNormalCattleBoss.CallChat[index], 1, 500);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FourNormalCattleBoss.KillAttackChat.Length);
      this.Body.Say(FourNormalCattleBoss.KillAttackChat[index], 1, 500);
