...
// Type: GameServerScript.AI.NPC.SeventhHardHouseAi
...
namespace GameServerScript.AI.NPC
{
  public class SeventhHardHouseAi : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, SeventhHardHouseAi.KillAttackChat.Length);
      this.Body.Say(SeventhHardHouseAi.KillAttackChat[index], 1, 1000);
