...
// Type: GameServerScript.AI.NPC.FiveHardFourNpc1
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardFourNpc1 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveHardFourNpc1.KillAttackChat.Length);
      this.Body.Say(FiveHardFourNpc1.KillAttackChat[index], 1, 1000);
