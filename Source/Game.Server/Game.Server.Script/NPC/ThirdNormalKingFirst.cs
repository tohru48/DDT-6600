...
// Type: GameServerScript.AI.NPC.ThirdNormalKingFirst
...
namespace GameServerScript.AI.NPC
{
  public class ThirdNormalKingFirst : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingFirst.KillAttackChat.Length);
      this.Body.Say(ThirdNormalKingFirst.KillAttackChat[index], 0, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirdNormalKingFirst.CallChat.Length);
      this.Body.Say(ThirdNormalKingFirst.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingFirst.ShootChat.Length);
      this.Body.Say(ThirdNormalKingFirst.ShootChat[index], 0, 0);
