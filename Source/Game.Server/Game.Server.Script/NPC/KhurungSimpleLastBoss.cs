...
// Type: GameServerScript.AI.NPC.KhurungSimpleLastBoss
...
{
  public class KhurungSimpleLastBoss : ABrain
  {
    private int m_attackTurn = 0;
    private int npcID = 28006;
    ...
    {
      int index = this.Game.Random.Next(0, KhurungSimpleLastBoss.KillAttackChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttack2()
    {
      ...
      int index = this.Game.Random.Next(0, KhurungSimpleLastBoss.ShootChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.ShootChat[index], 1, 0);
      this.Game.Random.Next(670, 880);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, KhurungSimpleLastBoss.AllAttackChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.AllAttackChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, KhurungSimpleLastBoss.KillPlayerChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnDiedSay()
    {
      int index = this.Game.Random.Next(0, KhurungSimpleLastBoss.DiedChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.DiedChat[index], 1, 0, 1500);
    }
    ...
    {
      int index1 = this.Game.Random.Next(0, KhurungSimpleLastBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(KhurungSimpleLastBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, KhurungSimpleLastBoss.DiedChat.Length);
      this.Body.Say(KhurungSimpleLastBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
