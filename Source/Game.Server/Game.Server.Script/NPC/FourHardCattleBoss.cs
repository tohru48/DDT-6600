...
// Type: GameServerScript.AI.NPC.FourHardCattleBoss
...
namespace GameServerScript.AI.NPC
{
  public class FourHardCattleBoss : ABrain
  {
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FourHardCattleBoss.KillAttackChat.Length);
      this.Body.Say(FourHardCattleBoss.KillAttackChat[index], 1, 500);
