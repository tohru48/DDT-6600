...
// Type: GameServerScript.AI.NPC.HardKingFirst
...
namespace GameServerScript.AI.NPC
{
  public class HardKingFirst : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, HardKingFirst.KillAttackChat.Length);
      this.Body.Say(HardKingFirst.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, HardKingFirst.AllAttackChat.Length);
      this.Body.Say(HardKingFirst.AllAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, HardKingFirst.AddBooldChat.Length);
      this.Body.Say(HardKingFirst.AddBooldChat[index], 1, 0);
      this.Body.SyncAtTime = true;
      this.Body.AddBlood(10000);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, HardKingFirst.ShootChat.Length);
      this.Body.Say(HardKingFirst.ShootChat[index], 1, 0);
      if (randomPlayer == null)
        return;
      int x = this.Game.Random.Next(randomPlayer.X - 50, randomPlayer.X + 50);
      if (this.Body.ShootPoint(x, randomPlayer.Y, 61, 1000, 10000, 1, 1f, 2300))
        this.Body.PlayMovie("beat2", 1500, 0);
      if (this.Body.ShootPoint(x, randomPlayer.Y, 61, 1000, 10000, 1, 1f, 4100))
