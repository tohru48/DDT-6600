...
// Type: GameServerScript.AI.NPC.NormalKingZhen
...
namespace GameServerScript.AI.NPC
{
  public class NormalKingZhen : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, NormalKingZhen.SealChat.Length);
      this.Body.Say(NormalKingZhen.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, NormalKingZhen.CallChat.Length);
      this.Body.Say(NormalKingZhen.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, NormalKingZhen.SealChat.Length);
      this.Body.Say(NormalKingZhen.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, NormalKingZhen.AngryChat.Length);
      this.Body.Say(NormalKingZhen.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, NormalKingZhen.KillAttackChat.Length);
      this.Body.Say(NormalKingZhen.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
