...
// Type: GameServerScript.AI.NPC.CryptBoss6
  ...
  public class CryptBoss6 : ABrain
  {
    ...
    private void AttackA()
    {
      ...
      if (nearestPlayer == null)
        return;
      this.Body.MoveTo(nearestPlayer.X + 90, nearestPlayer.Y, "fly", 1000, "", 18, new LivingCallBack(this.NextAttackA));
    }
    ...
    private void AttackC()
    {
      ...
      if (nearestPlayer == null)
        return;
      this.Body.MoveTo(nearestPlayer.X + 99, nearestPlayer.Y, "fly", 1000, "", 18, new LivingCallBack(this.NextAttackC));
    }
    ...
    private void NextAttackC()
    {
      ...
      this.Body.CallFuction(new LivingCallBack(this.RangeAttackingC), 4500);
    }
    ...
    private void AttackB()
    {
      ...
      if (nearestPlayer == null)
        return;
      this.Body.MoveTo(nearestPlayer.X + 112, nearestPlayer.Y, "fly", 1000, "", 18, new LivingCallBack(this.NextAttackB));
    }
    ...
    {
      int x = this.Game.Random.Next(577, 1045);
      int y = this.Game.Random.Next(344, 675);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      this.Body.MoveTo(x, y, "fly", 1000, "", 18, new LivingCallBack(this.ChangeDirection));
    }
