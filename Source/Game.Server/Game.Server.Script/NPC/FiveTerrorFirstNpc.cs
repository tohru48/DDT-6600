...
// Type: GameServerScript.AI.NPC.FiveTerrorFirstNpc
...
namespace GameServerScript.AI.NPC
{
  public class FiveTerrorFirstNpc : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveTerrorFirstNpc.KillAttackChat.Length);
      this.Body.Say(FiveTerrorFirstNpc.KillAttackChat[index], 1, 1000);
