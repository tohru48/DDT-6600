...
// Type: GameServerScript.AI.NPC.NormalKingLast
...
namespace GameServerScript.AI.NPC
{
  public class NormalKingLast : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, NormalKingLast.SealChat.Length);
      this.Body.Say(NormalKingLast.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, NormalKingLast.CallChat.Length);
      this.Body.Say(NormalKingLast.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, NormalKingLast.SealChat.Length);
      this.Body.Say(NormalKingLast.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, NormalKingLast.AngryChat.Length);
      this.Body.Say(NormalKingLast.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, NormalKingLast.KillAttackChat.Length);
      this.Body.Say(NormalKingLast.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
