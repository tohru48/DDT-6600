...
// Type: GameServerScript.AI.NPC.ThirteenNormalBrotherNpc
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalBrotherNpc : ABrain
  {
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalBrotherNpc.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalBrotherNpc.KillAttackChat[index], 1, 500);
