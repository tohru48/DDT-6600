...
// Type: GameServerScript.AI.NPC.ThirdTerrorKingFirst
...
namespace GameServerScript.AI.NPC
{
  public class ThirdTerrorKingFirst : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingFirst.KillAttackChat.Length);
      this.Body.Say(ThirdTerrorKingFirst.KillAttackChat[index], 0, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirdTerrorKingFirst.CallChat.Length);
      this.Body.Say(ThirdTerrorKingFirst.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingFirst.ShootChat.Length);
      this.Body.Say(ThirdTerrorKingFirst.ShootChat[index], 0, 0);
