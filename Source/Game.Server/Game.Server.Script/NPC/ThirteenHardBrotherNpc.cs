...
// Type: GameServerScript.AI.NPC.ThirteenHardBrotherNpc
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenHardBrotherNpc : ABrain
  {
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenHardBrotherNpc.KillAttackChat.Length);
      this.Body.Say(ThirteenHardBrotherNpc.KillAttackChat[index], 1, 500);
