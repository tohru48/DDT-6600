...
// Type: GameServerScript.AI.NPC.UKTerrorFastLastTerrorGame
...
{
  public class UKTerrorFastLastTerrorGame : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, UKTerrorFastLastTerrorGame.BeatOneKillChat.Length);
      this.Body.Say(UKTerrorFastLastTerrorGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
