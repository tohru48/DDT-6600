...
// Type: GameServerScript.AI.NPC.ThirteenTerrorDevilBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenTerrorDevilBoss : ABrain
  {
    ...
    private void CallHopquaidi()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorDevilBoss.ShootChat.Length);
      this.Body.Say(ThirteenTerrorDevilBoss.ShootChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenTerrorDevilBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenTerrorDevilBoss.AddBooldChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenTerrorDevilBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenTerrorDevilBoss.KillAttackChat[index], 1, 1000);
