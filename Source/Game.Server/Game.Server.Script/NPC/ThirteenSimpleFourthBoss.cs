...
// Type: GameServerScript.AI.NPC.ThirteenSimpleFourthBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleFourthBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleFourthBoss.AngryChat.Length);
      this.Body.Say(ThirteenSimpleFourthBoss.AngryChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleFourthBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleFourthBoss.KillAttackChat[index], 1, 500);
