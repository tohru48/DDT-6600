...
// Type: GameServerScript.AI.NPC.ThirdSimpleKingFour
...
namespace GameServerScript.AI.NPC
{
  public class ThirdSimpleKingFour : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdSimpleKingFour.SealChat.Length);
      this.Body.Say(ThirdSimpleKingFour.AllAttackChat[index], 1, 500);
    ...
    private void PersonalAttackDame()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdSimpleKingFour.ShootChat.Length);
      this.Body.Say(ThirdSimpleKingFour.ShootChat[index], 1, 500);
      int num;
    ...
    {
      int index = this.Game.Random.Next(0, ThirdSimpleKingFour.CallChat.Length);
      this.Body.Say(ThirdSimpleKingFour.CallChat[index], 1, 500);
      if (this.IsEixt == 1)
      {
        this.Body.ChangeDirection(1, 50);
    ...
    public void Summon()
    {
      ...
      else
      {
        ...
        int index = this.Game.Random.Next(0, ThirdSimpleKingFour.KillPlayerChat.Length);
        this.Body.Say(ThirdSimpleKingFour.KillPlayerChat[index], 1, 500);
    ...
    public void MovePlayer()
    {
      ...
      else
      {
        ...
        this.Game.FindRandomPlayer();
        int index = this.Game.Random.Next(0, ThirdSimpleKingFour.SealChat.Length);
        this.Body.Say(ThirdSimpleKingFour.SealChat[index], 1, 500);
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdSimpleKingFour.KillAttackChat.Length);
      this.Body.Say(ThirdSimpleKingFour.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatC", 2500, 0);
