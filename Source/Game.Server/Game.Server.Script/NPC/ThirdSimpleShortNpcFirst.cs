...
// Type: GameServerScript.AI.NPC.ThirdSimpleShortNpcFirst
  ...
  public class ThirdSimpleShortNpcFirst : ABrain
  {
    ...
    public override void OnBeginNewTurn()
    {
      ...
      if (!this.m_body.IsSay)
        return;
      this.m_body.Say(ThirdSimpleShortNpcFirst.GetOneChat(), 0, this.Game.Random.Next(0, 5000));
    }
    ...
    {
      int index = ThirdSimpleShortNpcFirst.random.Next(0, ThirdSimpleShortNpcFirst.listChat.Length);
      return ThirdSimpleShortNpcFirst.listChat[index];
    }
    ...
    public static void LivingSay(List<Living> livings)
    {
      ...
      while (num < length)
      {
        int index = ThirdSimpleShortNpcFirst.random.Next(0, count);
        if (!livings[index].IsSay)
        {
          livings[index].IsSay = true;
          int delay = ThirdSimpleShortNpcFirst.random.Next(0, 5000);
