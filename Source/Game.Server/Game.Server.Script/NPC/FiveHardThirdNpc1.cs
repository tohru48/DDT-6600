...
// Type: GameServerScript.AI.NPC.FiveHardThirdNpc1
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardThirdNpc1 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveHardThirdNpc1.KillAttackChat.Length);
      this.Body.Say(FiveHardThirdNpc1.KillAttackChat[index], 1, 1000);
