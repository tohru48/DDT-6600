...
// Type: GameServerScript.AI.NPC.FiveHardFourBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardFourBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveHardFourBoss.KillAttackChat.Length);
      this.Body.Say(FiveHardFourBoss.KillAttackChat[index], 1, 1000);
