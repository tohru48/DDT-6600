...
// Type: GameServerScript.AI.NPC.ThirdNormalKingThird
...
namespace GameServerScript.AI.NPC
{
  public class ThirdNormalKingThird : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingThird.SealChat.Length);
      this.Body.Say(ThirdNormalKingThird.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ThirdNormalKingThird.CallChat.Length);
      this.Body.Say(ThirdNormalKingThird.CallChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingThird.KillAttackChat.Length);
      this.Body.Say(ThirdNormalKingThird.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatC", 2500, 0);
