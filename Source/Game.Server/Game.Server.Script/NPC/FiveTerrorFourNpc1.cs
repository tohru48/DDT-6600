...
// Type: GameServerScript.AI.NPC.FiveTerrorFourNpc1
...
namespace GameServerScript.AI.NPC
{
  public class FiveTerrorFourNpc1 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveTerrorFourNpc1.KillAttackChat.Length);
      this.Body.Say(FiveTerrorFourNpc1.KillAttackChat[index], 1, 1000);
