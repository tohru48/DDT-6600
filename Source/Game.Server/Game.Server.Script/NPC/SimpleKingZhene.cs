...
// Type: GameServerScript.AI.NPC.SimpleKingZhene
...
{
  public class SimpleKingZhene : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, SimpleKingZhene.SealChat.Length);
      this.Body.Say(SimpleKingZhene.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, SimpleKingZhene.CallChat.Length);
      this.Body.Say(SimpleKingZhene.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, SimpleKingZhene.SealChat.Length);
      this.Body.Say(SimpleKingZhene.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, SimpleKingZhene.AngryChat.Length);
      this.Body.Say(SimpleKingZhene.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, SimpleKingZhene.KillAttackChat.Length);
      this.Body.Say(SimpleKingZhene.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
