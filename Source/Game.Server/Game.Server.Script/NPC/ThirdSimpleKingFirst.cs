...
// Type: GameServerScript.AI.NPC.ThirdSimpleKingFirst
...
namespace GameServerScript.AI.NPC
{
  public class ThirdSimpleKingFirst : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdSimpleKingFirst.KillAttackChat.Length);
      this.Body.Say(ThirdSimpleKingFirst.KillAttackChat[index], 0, 1000);
    ...
    {
      int index = this.Game.Random.Next(0, ThirdSimpleKingFirst.CallChat.Length);
      this.Body.Say(ThirdSimpleKingFirst.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdSimpleKingFirst.ShootChat.Length);
      this.Body.Say(ThirdSimpleKingFirst.ShootChat[index], 0, 0);
