...
// Type: GameServerScript.AI.NPC.UKTerrorFastLastNormalGame
...
{
  public class UKTerrorFastLastNormalGame : ABrain
  {
    private int m_attackTurn = 0;
    private int npcID = 14105;
    private int npcID2 = 13113;
    private int npcID3 = 13114;
    private PhysicalObj m_moive = (PhysicalObj) null;
    private static string[] BeatOneKillChat = new string[3]
    {
      "A guerra apenas acaba de começar",
      "Todos serão aniquilados, vocês não tem chance alguma.",
      "Vamos brincar...gosta disto?"
    };
    ...
    {
      int index = this.Game.Random.Next(0, UKTerrorFastLastNormalGame.BeatOneKillChat.Length);
      this.Body.Say(UKTerrorFastLastNormalGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
