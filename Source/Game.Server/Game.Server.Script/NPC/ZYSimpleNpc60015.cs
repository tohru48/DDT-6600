...
// Type: GameServerScript.AI.NPC.ZYSimpleNpc60015
...
namespace GameServerScript.AI.NPC
{
  public class ZYSimpleNpc60015 : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60015.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60015.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60015.CallChat.Length);
      this.Body.Say(ZYSimpleNpc60015.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60015.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60015.SealChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60015.KillAttackChat.Length);
      this.Body.Say(ZYSimpleNpc60015.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
