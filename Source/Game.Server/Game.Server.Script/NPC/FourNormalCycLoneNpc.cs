...
// Type: GameServerScript.AI.NPC.FourNormalCycLoneNpc
...
namespace GameServerScript.AI.NPC
{
  public class FourNormalCycLoneNpc : ABrain
  {
    ...
    public void BestC()
    {
      ...
      int num = this.Game.Random.Next(400, 1680);
      this.Body.RangeAttacking(num, num, "cry", 4000, (List<Player>) null);
      this.Body.CallFuction(new LivingCallBack(this.CreateChild), 2500);
    }

    public void CreateChild()
    {
      ((SimpleBoss) this.Body).CreateChild(this.npcID, this.Game.Random.Next(470, 880), 700, 400, 2, -1);
    }

    public void CreateChild2()
    {
      ((SimpleBoss) this.Body).CreateChild(this.npcID2, this.Game.Random.Next(340, 340), 700, 400, 1, 1);
    }
