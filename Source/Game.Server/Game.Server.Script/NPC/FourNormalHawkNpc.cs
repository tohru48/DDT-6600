...
// Type: GameServerScript.AI.NPC.FourNormalHawkNpc
...
namespace GameServerScript.AI.NPC
{
  public class FourNormalHawkNpc : ABrain
  {
    ...
    {
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, FourNormalHawkNpc.AllAttackChat.Length);
      this.Body.Say(FourNormalHawkNpc.AllAttackChat[index], 1, 1000);
