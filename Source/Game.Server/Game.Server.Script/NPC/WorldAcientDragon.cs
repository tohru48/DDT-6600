...
// Type: GameServerScript.AI.NPC.WorldAcientDragon
...
namespace GameServerScript.AI.NPC
{
  public class WorldAcientDragon : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, WorldAcientDragon.KillAttackChat.Length);
      this.Body.Say(WorldAcientDragon.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttackC()
    {
      ...
      int index = this.Game.Random.Next(0, WorldAcientDragon.ShootChat.Length);
      this.Body.Say(WorldAcientDragon.ShootChat[index], 1, 0);
