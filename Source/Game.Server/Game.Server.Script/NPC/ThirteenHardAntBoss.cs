...
// Type: GameServerScript.AI.NPC.ThirteenHardAntBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenHardAntBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenHardAntBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenHardAntBoss.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenHardAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenHardAntBoss.KillPlayerChat[index], 1, 0);
    ...
    private void Plain()
    {
      int index = this.Game.Random.Next(0, ThirteenHardAntBoss.ShootChat.Length);
      this.Body.Say(ThirteenHardAntBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenHardAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenHardAntBoss.KillPlayerChat[index], 1, 0, 2000);
    }
    ...
    {
      int index1 = this.Game.Random.Next(0, ThirteenHardAntBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenHardAntBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenHardAntBoss.DiedChat.Length);
      this.Body.Say(ThirteenHardAntBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
