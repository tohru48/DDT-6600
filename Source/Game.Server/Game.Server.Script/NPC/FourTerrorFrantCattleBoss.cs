...
// Type: GameServerScript.AI.NPC.FourTerrorFrantCattleBoss
...
namespace GameServerScript.AI.NPC
{
  public class FourTerrorFrantCattleBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, FourTerrorFrantCattleBoss.KillAttackChat.Length);
      this.Body.Say(FourTerrorFrantCattleBoss.KillAttackChat[index], 1, 1000);
