...
// Type: GameServerScript.AI.NPC.SeventhHardFirstBoss
...
namespace GameServerScript.AI.NPC
{
  public class SeventhHardFirstBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, SeventhHardFirstBoss.KillAttackChat.Length);
      this.Body.Say(SeventhHardFirstBoss.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttack()
    {
      ...
      if (randomPlayer == null)
        return;
      this.Body.CurrentDamagePlus = 1.6f;
      ...
      if (this.Body.ShootPoint(randomPlayer.X, randomPlayer.Y, 84, 1200, 10000, 1, 3f, 5550))
        this.Body.PlayMovie("beatA", 1700, 0);
    }
