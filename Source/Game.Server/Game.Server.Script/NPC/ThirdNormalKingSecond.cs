...
// Type: GameServerScript.AI.NPC.ThirdNormalKingSecond
...
namespace GameServerScript.AI.NPC
{
  public class ThirdNormalKingSecond : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingSecond.KillAttackChat.Length);
      this.Body.Say(ThirdNormalKingSecond.KillAttackChat[index], 1, 1000);
    ...
    private void Summon()
    {
      int index = this.Game.Random.Next(0, ThirdNormalKingSecond.CallChat.Length);
      this.Body.Say(ThirdNormalKingSecond.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingSecond.ShootChat.Length);
      this.Body.Say(ThirdNormalKingSecond.ShootChat[index], 0, 0);
