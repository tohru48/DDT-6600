...
// Type: GameServerScript.AI.NPC.ThirteenNormalAntBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalAntBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenNormalAntBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalAntBoss.KillAttackChat[index], 1, 1000);
    ...
    private void PersonalAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenNormalAntBoss.KillPlayerChat[index], 1, 0);
    ...
    private void Plain()
    {
      int index = this.Game.Random.Next(0, ThirteenNormalAntBoss.ShootChat.Length);
      this.Body.Say(ThirteenNormalAntBoss.ShootChat[index], 1, 0);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalAntBoss.KillPlayerChat.Length);
      this.Body.Say(ThirteenNormalAntBoss.KillPlayerChat[index], 1, 0, 2000);
    }
    ...
    {
      int index1 = this.Game.Random.Next(0, ThirteenNormalAntBoss.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(ThirteenNormalAntBoss.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, ThirteenNormalAntBoss.DiedChat.Length);
      this.Body.Say(ThirteenNormalAntBoss.DiedChat[index2], 1, 100, 2000);
    }
  }
}
