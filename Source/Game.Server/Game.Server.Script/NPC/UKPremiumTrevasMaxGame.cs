...
// Type: GameServerScript.AI.NPC.UKPremiumTrevasMaxGame
...
{
  public class UKPremiumTrevasMaxGame : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, UKPremiumTrevasMaxGame.BeatOneKillChat.Length);
      this.Body.Say(UKPremiumTrevasMaxGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
