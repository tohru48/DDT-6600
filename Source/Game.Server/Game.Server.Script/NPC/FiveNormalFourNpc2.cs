...
// Type: GameServerScript.AI.NPC.FiveNormalFourNpc2
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalFourNpc2 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveNormalFourNpc2.KillAttackChat.Length);
      this.Body.Say(FiveNormalFourNpc2.KillAttackChat[index], 1, 1000);
