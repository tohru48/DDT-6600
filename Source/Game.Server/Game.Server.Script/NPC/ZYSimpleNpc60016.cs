...
// Type: GameServerScript.AI.NPC.ZYSimpleNpc60016
...
namespace GameServerScript.AI.NPC
{
  public class ZYSimpleNpc60016 : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60016.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60016.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60016.CallChat.Length);
      this.Body.Say(ZYSimpleNpc60016.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60016.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60016.SealChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60016.KillAttackChat.Length);
      this.Body.Say(ZYSimpleNpc60016.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
