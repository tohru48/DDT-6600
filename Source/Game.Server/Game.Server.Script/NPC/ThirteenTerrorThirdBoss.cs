...
// Type: GameServerScript.AI.NPC.ThirteenTerrorThirdBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenTerrorThirdBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, ThirteenTerrorThirdBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenTerrorThirdBoss.KillAttackChat[index], 1, 1000);
