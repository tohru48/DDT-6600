...
// Type: GameServerScript.AI.NPC.UKPremiumTrevasMaxTerrGame
...
{
  public class UKPremiumTrevasMaxTerrGame : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, UKPremiumTrevasMaxTerrGame.BeatOneKillChat.Length);
      this.Body.Say(UKPremiumTrevasMaxTerrGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
