...
// Type: GameServerScript.AI.NPC.ThirteenNormalFourthBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalFourthBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenNormalFourthBoss.AngryChat.Length);
      this.Body.Say(ThirteenNormalFourthBoss.AngryChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenNormalFourthBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalFourthBoss.KillAttackChat[index], 1, 500);
