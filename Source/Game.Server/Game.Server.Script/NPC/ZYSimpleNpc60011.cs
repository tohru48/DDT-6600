...
// Type: GameServerScript.AI.NPC.ZYSimpleNpc60011
...
namespace GameServerScript.AI.NPC
{
  public class ZYSimpleNpc60011 : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60011.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60011.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60011.CallChat.Length);
      this.Body.Say(ZYSimpleNpc60011.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60011.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60011.SealChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60011.KillAttackChat.Length);
      this.Body.Say(ZYSimpleNpc60011.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
