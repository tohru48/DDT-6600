...
// Type: GameServerScript.AI.NPC.ThirteenNormalThirdBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenNormalThirdBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, ThirteenNormalThirdBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenNormalThirdBoss.KillAttackChat[index], 1, 1000);
