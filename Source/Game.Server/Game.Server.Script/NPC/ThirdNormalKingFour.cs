...
// Type: GameServerScript.AI.NPC.ThirdNormalKingFour
...
namespace GameServerScript.AI.NPC
{
  public class ThirdNormalKingFour : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingFour.SealChat.Length);
      this.Body.Say(ThirdNormalKingFour.AllAttackChat[index], 1, 500);
    ...
    private void PersonalAttackDame()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingFour.ShootChat.Length);
      this.Body.Say(ThirdNormalKingFour.ShootChat[index], 1, 500);
      int num;
    ...
    {
      int index = this.Game.Random.Next(0, ThirdNormalKingFour.CallChat.Length);
      this.Body.Say(ThirdNormalKingFour.CallChat[index], 1, 500);
      if (this.IsEixt == 1)
      {
        this.Body.ChangeDirection(1, 50);
    ...
    public void Summon()
    {
      ...
      else
      {
        ...
        int index = this.Game.Random.Next(0, ThirdNormalKingFour.KillPlayerChat.Length);
        this.Body.Say(ThirdNormalKingFour.KillPlayerChat[index], 1, 500);
    ...
    public void MovePlayer()
    {
      ...
      else
      {
        ...
        this.Game.FindRandomPlayer();
        int index = this.Game.Random.Next(0, ThirdNormalKingFour.SealChat.Length);
        this.Body.Say(ThirdNormalKingFour.SealChat[index], 1, 500);
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdNormalKingFour.KillAttackChat.Length);
      this.Body.Say(ThirdNormalKingFour.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatC", 2500, 0);
