...
// Type: GameServerScript.AI.NPC.FourHardFrantCattleBoss
...
namespace GameServerScript.AI.NPC
{
  public class FourHardFrantCattleBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
      int index = this.Game.Random.Next(0, FourHardFrantCattleBoss.KillAttackChat.Length);
      this.Body.Say(FourHardFrantCattleBoss.KillAttackChat[index], 1, 1000);
