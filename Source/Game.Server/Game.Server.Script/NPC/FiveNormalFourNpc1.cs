...
// Type: GameServerScript.AI.NPC.FiveNormalFourNpc1
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalFourNpc1 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveNormalFourNpc1.KillAttackChat.Length);
      this.Body.Say(FiveNormalFourNpc1.KillAttackChat[index], 1, 1000);
    ...
    {
      if (this.Body.Shoot(4, 1732, 380, 45, 7, 1, 15000))
        this.Body.PlayMovie("beatC", 0, 0);
      if (!this.Body.Shoot(4, 1732, 380, 45, 7, 1, 15000))
        ;
      if (!this.Body.Shoot(4, 1732, 380, 45, 7, 1, 15000))
        ;
