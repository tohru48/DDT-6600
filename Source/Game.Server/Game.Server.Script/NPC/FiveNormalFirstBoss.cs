...
// Type: GameServerScript.AI.NPC.FiveNormalFirstBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalFirstBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveNormalFirstBoss.KillAttackChat.Length);
      this.Body.Say(FiveNormalFirstBoss.KillAttackChat[index], 1, 1000);
