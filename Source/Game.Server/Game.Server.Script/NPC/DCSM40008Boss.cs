...
// Type: GameServerScript.AI.NPC.DCSM40008Boss
...
namespace GameServerScript.AI.NPC
{
  public class DCSM40008Boss : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, DCSM40008Boss.SealChat.Length);
      this.Body.Say(DCSM40008Boss.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, DCSM40008Boss.CallChat.Length);
      this.Body.Say(DCSM40008Boss.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, DCSM40008Boss.SealChat.Length);
      this.Body.Say(DCSM40008Boss.SealChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, DCSM40008Boss.KillAttackChat.Length);
      this.Body.Say(DCSM40008Boss.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
