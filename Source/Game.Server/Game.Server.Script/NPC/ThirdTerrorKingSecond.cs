...
// Type: GameServerScript.AI.NPC.ThirdTerrorKingSecond
...
namespace GameServerScript.AI.NPC
{
  public class ThirdTerrorKingSecond : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingSecond.KillAttackChat.Length);
      this.Body.Say(ThirdTerrorKingSecond.KillAttackChat[index], 1, 1000);
    ...
    private void Summon()
    {
      int index = this.Game.Random.Next(0, ThirdTerrorKingSecond.CallChat.Length);
      this.Body.Say(ThirdTerrorKingSecond.CallChat[index], 0, 3300);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirdTerrorKingSecond.ShootChat.Length);
      this.Body.Say(ThirdTerrorKingSecond.ShootChat[index], 0, 0);
