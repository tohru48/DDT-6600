...
// Type: GameServerScript.AI.NPC.ThirteenSimpleNioBoss
...
namespace GameServerScript.AI.NPC
{
  public class ThirteenSimpleNioBoss : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleNioBoss.KillAttackChat.Length);
      this.Body.Say(ThirteenSimpleNioBoss.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleNioBoss.AllAttackChat.Length);
      this.Body.Say(ThirteenSimpleNioBoss.AllAttackChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, ThirteenSimpleNioBoss.AddBooldChat.Length);
      this.Body.Say(ThirteenSimpleNioBoss.AddBooldChat[index], 1, 0);
    ...
    private void NextAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ThirteenSimpleNioBoss.ShootChat.Length);
      this.Body.Say(ThirteenSimpleNioBoss.ShootChat[index], 1, 0);
