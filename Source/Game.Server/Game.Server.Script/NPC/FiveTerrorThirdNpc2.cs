...
// Type: GameServerScript.AI.NPC.FiveTerrorThirdNpc2
...
namespace GameServerScript.AI.NPC
{
  public class FiveTerrorThirdNpc2 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveTerrorThirdNpc2.KillAttackChat.Length);
      this.Body.Say(FiveTerrorThirdNpc2.KillAttackChat[index], 1, 1000);
