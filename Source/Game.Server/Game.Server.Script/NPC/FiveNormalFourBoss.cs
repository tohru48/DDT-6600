...
// Type: GameServerScript.AI.NPC.FiveNormalFourBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalFourBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveNormalFourBoss.KillAttackChat.Length);
      this.Body.Say(FiveNormalFourBoss.KillAttackChat[index], 1, 1000);
