...
// Type: GameServerScript.AI.NPC.UKTerrorMdarkGame
...
{
  public class UKTerrorMdarkGame : ABrain
  {
    private int m_attackTurn = 0;
    private PhysicalObj m_moive = (PhysicalObj) null;
    private static string[] BeatOneKillChat = new string[2]
    {
      "Nosso Reino saíra vitorioso, isso eu tenho certeza",
      "Esquatejarei todos vocês, fazerei seus sangues jorrarem, suas cabeças caírem e se curvarem diante de nós."
    };
    ...
    private static string[] AddBooldChat = new string[2]
    {
      "Nosso Reino saíra vitorioso, isso eu tenho certeza",
      "Esquatejarei todos vocês, fazerei seus sangues jorrarem, suas cabeças caírem e se curvarem diante de nós."
    };
    ...
    {
      int index = this.Game.Random.Next(0, UKTerrorMdarkGame.BeatOneKillChat.Length);
      this.Body.Say(UKTerrorMdarkGame.BeatOneKillChat[index], 1, 0);
      this.Body.Direction = this.Game.FindlivingbyDir(this.Body);
