...
// Type: GameServerScript.AI.NPC.SeventhSimpleFirstBoss
...
namespace GameServerScript.AI.NPC
{
  public class SeventhSimpleFirstBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, SeventhSimpleFirstBoss.KillAttackChat.Length);
      this.Body.Say(SeventhSimpleFirstBoss.KillAttackChat[index], 1, 1000);
