...
// Type: GameServerScript.AI.NPC.HardKingLast
...
namespace GameServerScript.AI.NPC
{
  public class HardKingLast : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, HardKingLast.SealChat.Length);
      this.Body.Say(HardKingLast.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, HardKingLast.CallChat.Length);
      this.Body.Say(HardKingLast.CallChat[index], 1, 0);
    ...
    {
      int index = this.Game.Random.Next(0, HardKingLast.SealChat.Length);
      this.Body.Say(HardKingLast.SealChat[index], 1, 0);
    ...
    public void Angger()
    {
      int index = this.Game.Random.Next(0, HardKingLast.AngryChat.Length);
      this.Body.Say(HardKingLast.AngryChat[index], 1, 0);
      this.Body.State = 1;
      this.Dander += 100;
    ...
    public void KillAttack(int fx, int mx)
    {
      ...
      int index = this.Game.Random.Next(0, HardKingLast.KillAttackChat.Length);
      this.Body.Say(HardKingLast.KillAttackChat[index], 1, 500);
      this.Body.PlayMovie("beatB", 2500, 0);
