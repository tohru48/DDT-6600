...
// Type: GameServerScript.AI.NPC.FiveNormalThirdNpc2
...
namespace GameServerScript.AI.NPC
{
  public class FiveNormalThirdNpc2 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveNormalThirdNpc2.KillAttackChat.Length);
      this.Body.Say(FiveNormalThirdNpc2.KillAttackChat[index], 1, 1000);
