...
// Type: GameServerScript.AI.NPC.NewTrainingBoss24002
...
namespace GameServerScript.AI.NPC
{
  public class NewTrainingBoss24002 : ABrain
  {
    ...
    public override void OnStartAttacking()
    {
      ...
      {
        ++this.m_attackTurn;
        this.Body.Say("Bay ra ngoài đi，núp trong đóa ko thịt được ta đâu！", 0, 3000);
      }
      else
        this.PersonalAttack();
    }
    ...
    private void NextAttack()
    {
      ...
      if (randomPlayer == null || !this.Body.ShootPoint(this.Game.Random.Next(randomPlayer.X - 50, randomPlayer.X + 50), randomPlayer.Y, ((SimpleBoss) this.Body).NpcInfo.CurrentBallId, 1000, 10000, 1, 1f, 3200))
        return;
      this.Body.PlayMovie("beatA", 2700, 0);
    }
  }
}
