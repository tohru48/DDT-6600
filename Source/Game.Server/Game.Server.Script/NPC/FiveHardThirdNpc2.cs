...
// Type: GameServerScript.AI.NPC.FiveHardThirdNpc2
...
namespace GameServerScript.AI.NPC
{
  public class FiveHardThirdNpc2 : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, FiveHardThirdNpc2.KillAttackChat.Length);
      this.Body.Say(FiveHardThirdNpc2.KillAttackChat[index], 1, 1000);
