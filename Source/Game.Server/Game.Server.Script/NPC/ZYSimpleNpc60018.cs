...
// Type: GameServerScript.AI.NPC.ZYSimpleNpc60018
...
namespace GameServerScript.AI.NPC
{
  public class ZYSimpleNpc60018 : ABrain
  {
    ...
    public void HalfAttack()
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60018.SealChat.Length);
      this.Body.Say(ZYSimpleNpc60018.AllAttackChat[index], 1, 500);
    ...
    public void Summon()
    {
      int index = this.Game.Random.Next(0, ZYSimpleNpc60018.CallChat.Length);
      this.Body.Say(ZYSimpleNpc60018.CallChat[index], 1, 0);
    ...
    public void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, ZYSimpleNpc60018.KillAttackChat.Length);
      this.Body.Say(ZYSimpleNpc60018.KillAttackChat[index], 1, 500);
