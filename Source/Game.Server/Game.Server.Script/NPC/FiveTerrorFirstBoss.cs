...
// Type: GameServerScript.AI.NPC.FiveTerrorFirstBoss
...
namespace GameServerScript.AI.NPC
{
  public class FiveTerrorFirstBoss : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, FiveTerrorFirstBoss.KillAttackChat.Length);
      this.Body.Say(FiveTerrorFirstBoss.KillAttackChat[index], 1, 1000);
