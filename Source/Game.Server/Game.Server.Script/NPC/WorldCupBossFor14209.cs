...
// Type: GameServerScript.AI.NPC.WorldCupBossFor14209
...
namespace GameServerScript.AI.NPC
{
  public class WorldCupBossFor14209 : ABrain
  {
    ...
    {
      int index = this.Game.Random.Next(0, WorldCupBossFor14209.KillAttackChat.Length);
      this.Body.Say(WorldCupBossFor14209.KillAttackChat[index], 1, 1000);
    ...
    private void AttackA(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, WorldCupBossFor14209.ShootChat.Length);
      this.Body.Say(WorldCupBossFor14209.ShootChat[index], 1, 0);
    ...
    private void AttackB(int fx, int tx)
    {
      if (this.Game.FindRandomPlayer() == null)
        return;
      this.Body.CurrentDamagePlus = 2.1f;
      int index = this.Game.Random.Next(0, WorldCupBossFor14209.ShootChat.Length);
      this.Body.Say(WorldCupBossFor14209.ShootChat[index], 1, 0);
      this.Game.Random.Next(0, 1200);
    ...
    public override void OnKillPlayerSay()
    {
      ...
      int index = this.Game.Random.Next(0, WorldCupBossFor14209.KillPlayerChat.Length);
      this.Body.Say(WorldCupBossFor14209.KillPlayerChat[index], 1, 0, 2000);
    }

    public override void OnShootedSay()
    {
      int index1 = this.Game.Random.Next(0, WorldCupBossFor14209.ShootedChat.Length);
      if (this.isSay == 0 && this.Body.IsLiving)
      {
        this.Body.Say(WorldCupBossFor14209.ShootedChat[index1], 1, 900, 0);
        this.isSay = 1;
      }
      if (this.Body.IsLiving)
        return;
      int index2 = this.Game.Random.Next(0, WorldCupBossFor14209.DiedChat.Length);
      this.Body.Say(WorldCupBossFor14209.DiedChat[index2], 1, 100, 2000);
    }
  }
}
