...
// Type: GameServerScript.AI.NPC.HardCaptainAi
...
namespace GameServerScript.AI.NPC
{
  public class HardCaptainAi : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, HardCaptainAi.KillAttackChat.Length);
      this.Body.Say(HardCaptainAi.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, HardCaptainAi.AllAttackChat.Length);
      this.Body.Say(HardCaptainAi.AllAttackChat[index], 1, 0);
    ...
    {
      this.ChangeDirection(3);
      int index = this.Game.Random.Next(0, HardCaptainAi.ShootChat.Length);
      this.Body.Say(HardCaptainAi.ShootChat[index], 1, 0);
    ...
    private void Summon()
    {
      ...
      int index = this.Game.Random.Next(0, HardCaptainAi.CallChat.Length);
      this.Body.Say(HardCaptainAi.CallChat[index], 1, 3300);
    ...
    private void NextAttack()
    {
      ...
      if (this.Body.ShootPoint(x, randomPlayer.Y, 61, 1000, 10000, 1, 1f, 2200))
        this.Body.PlayMovie("beat", 1700, 0);
      if (this.Body.ShootPoint(x, randomPlayer.Y, 61, 1000, 10000, 1, 1f, 3200))
