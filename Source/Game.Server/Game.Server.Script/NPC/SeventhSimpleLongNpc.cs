...
// Type: GameServerScript.AI.NPC.SeventhSimpleLongNpc
...
namespace GameServerScript.AI.NPC
{
  public class SeventhSimpleLongNpc : ABrain
  {
    ...
    private PhysicalObj effect = (PhysicalObj) null;
    ...
    public override void OnStartAttacking()
    {
      ...
      {
        if (allFightPlayer.IsLiving && allFightPlayer.X < 800)
        {
    ...
    private void GoMovie()
    {
      foreach (Player allFightPlayer in this.Game.GetAllFightPlayers())
      {
        this.effect = (PhysicalObj) ((PVEGame) this.Game).Createlayer(allFightPlayer.X, allFightPlayer.Y, "moive", "asset.game.seven.cao", "out", 1, 0);
