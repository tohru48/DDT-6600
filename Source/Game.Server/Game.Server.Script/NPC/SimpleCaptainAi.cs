...
// Type: GameServerScript.AI.NPC.SimpleCaptainAi
...
namespace GameServerScript.AI.NPC
{
  public class SimpleCaptainAi : ABrain
  {
    ...
    private void KillAttack(int fx, int tx)
    {
      ...
      int index = this.Game.Random.Next(0, SimpleCaptainAi.KillAttackChat.Length);
      this.Body.Say(SimpleCaptainAi.KillAttackChat[index], 1, 1000);
    ...
    private void AllAttack()
    {
      ...
      int index = this.Game.Random.Next(0, SimpleCaptainAi.AllAttackChat.Length);
      this.Body.Say(SimpleCaptainAi.AllAttackChat[index], 1, 0);
    ...
    {
      this.ChangeDirection(3);
      int index = this.Game.Random.Next(0, SimpleCaptainAi.ShootChat.Length);
      this.Body.Say(SimpleCaptainAi.ShootChat[index], 1, 0);
    ...
    private void Summon()
    {
      ...
      int index = this.Game.Random.Next(0, SimpleCaptainAi.CallChat.Length);
      this.Body.Say(SimpleCaptainAi.CallChat[index], 1, 3300);
