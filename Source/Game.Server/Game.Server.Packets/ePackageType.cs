namespace Game.Server.Packets
{
	public enum ePackageType
	{
		...
		KING_BLESS_MAIN = 142,
		KING_BLESS_UPDATE_BUFF_DATA = 143,
		...
		DRAGON_BOAT = 100,
		REQUEST_FRIENDS_PAY = 207,
		CAMPBATTLE = 146,
		FIND_BACK_INCOME = 147,
		GROUP_PURCHASE = 144,
		OLDPLAYER_REGRESS = 149,
		SEVEN_DOUBLE = 148,
		SEPARATE_ACTIVITY = 110,
		MISSION_ENERGY = 105,
		TRANSNATIONALFIGHT_ACTIVED = 154,
		TRANSNATIONAL_BUYGOODS = 156,
		FIGHTFOOTBALLTIMETAKEOUT = 152,
		FIGHTFOOTBALLTIMEACTIVE = 151,
		ACTIVITY_SYSTEM = 145,
		WONDERFUL_GETREWARD = 373,
		OLD_PLAYER_LOGIN = 345,
		BAGLOCK_PWD = 403,
		DEL_QUESTION = 493,
		ACTIVITY_PACKAGE = 84,
		ACCUMULATIVELOGIN_AWARD = 238,
		GET_CSM_BOX = 360,
		...
		COLLECTION_TASK = 261,
		TOTAL_CHARGE = 264,
		FAST_AUCTION_SMALL_BUGLE = 327,
		LIGHTROAD_SYSTEM = 145,
		SEVENDAYTARGET_GODSROADS = 145,
		KING_DIVISION = 328,
		SHOP_BUYLIMITEDCOUNT = 288,
		DEED_MAIN = 2272,
		DEED_UPDATE_BUFF_DATA = 2273,
		DEED_USE_ITEM = 143,
		TREASUREPUZZL = 145,
		CRYPTBOSS = 275,
		WORSHIP_THE_MOON_MID_AUTUMN = 281,
		MAGPIE_BRIDGE = 276,
		RESCUE = 277,
		MYSTERY_SHOP = 278,
		ITEM_ENCHANT = 280,
