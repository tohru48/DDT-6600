	...
	public class ConsortiaApplyUsersList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				ConsortiaApplyUserInfo[] consortiaApplyUserPage = consortiaBussiness.GetConsortiaApplyUserPage(page, size, ref num, order, consortiaID, applyID, userID);
				ConsortiaApplyUserInfo[] array = consortiaApplyUserPage;
