	...
	public class ConsortiaDutyList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				ConsortiaDutyInfo[] consortiaDutyPage = consortiaBussiness.GetConsortiaDutyPage(page, size, ref num, order, consortiaID, dutyID);
				ConsortiaDutyInfo[] array = consortiaDutyPage;
