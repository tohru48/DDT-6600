	...
	public class ConsortiaIMList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				{
					ConsortiaInfo consortiaSingle = consortiaBussiness.GetConsortiaSingle(num2);
				...
				ConsortiaUserInfo[] consortiaUsersPage = consortiaBussiness2.GetConsortiaUsersPage(1, 1000, ref num, -1, num2, -1, -1);
