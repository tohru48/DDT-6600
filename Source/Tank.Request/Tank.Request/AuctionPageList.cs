	...
	public class AuctionPageList : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			try
			{
				...
				AuctionInfo[] auctionPage = playerBussiness.GetAuctionPage(page, name, type, pay, ref num, userID, buyID, order, sort, size, text);
				AuctionInfo[] array = auctionPage;
				for (int i = 0; i < array.Length; i++)
				{
					AuctionInfo auctionInfo = array[i];
