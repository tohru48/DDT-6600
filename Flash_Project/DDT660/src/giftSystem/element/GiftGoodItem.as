package giftSystem.element
{
   ...
   public class GiftGoodItem extends Sprite implements ISelectable, Disposeable
   {
      ...
      private function init() : void
      {
         ...
         this._giftGoodItemBG = ComponentFactory.Instance.creatBitmap("asset.ddtgiftGoodItem.BG");
         ...
         this._line = ComponentFactory.Instance.creatComponentByStylename("core.ddtgiftSystem.line");
         this._line1 = ComponentFactory.Instance.creatComponentByStylename("core.ddtgiftSystem.line");
         this._line1.x = 68;
         this._line.x = 68;
         this._line.y = 44;
         this._line1.y = 61;
         ...
         if(Boolean(this._itemCell.info))
         {
            ...
            switch(this._info.getItemPrice(1).PriceType)
            {
               ...
               case Price.DDT_MONEY:
                  this._moneyName.text = LanguageMgr.GetTranslation("ddt.giftSystem.GiftGoodItem.bangdingmoney");
                  this._moneyValue.text = this._info.getItemPrice(1).bandDdtMoneyValue.toString();
            }
            this._icon.visible = this._info.Label == 0 ? false : true;
      ...
      public function dispose() : void
      {
         ...
         if(Boolean(this._giftGoodItemBG))
         {
            ObjectUtils.disposeObject(this._giftGoodItemBG);
         }
         this._giftGoodItemBG = null;
