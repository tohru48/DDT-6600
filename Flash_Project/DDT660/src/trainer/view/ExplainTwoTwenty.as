package trainer.view
{
   ...
   public class ExplainTwoTwenty extends BaseExplainFrame
   {
      ...
      {
         var posTwo:Point = null;
         var posTwenty:Point = null;
         ...
         posTwo = ComponentFactory.Instance.creatCustomObject("trainer.explain.posThreeBg");
         this._bmpNameBgTwo = ComponentFactory.Instance.creatBitmap("asset.explain.nameBgSmall");
         this._bmpNameBgTwo.x = posTwo.x;
         this._bmpNameBgTwo.y = posTwo.y;
         addChild(this._bmpNameBgTwo);
         posTwenty = ComponentFactory.Instance.creatCustomObject("trainer.explain.posPowerBg");
         this._bmpNameBgTwenty = ComponentFactory.Instance.creatBitmap("asset.explain.nameBgSmall");
         this._bmpNameBgTwenty.x = posTwenty.x;
         this._bmpNameBgTwenty.y = posTwenty.y;
