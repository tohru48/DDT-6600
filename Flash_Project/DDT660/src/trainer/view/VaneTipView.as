package trainer.view
{
   ...
   public class VaneTipView extends BaseAlerFrame
   {
      ...
      private function initView() : void
      {
         ...
         this._conent = ComponentFactory.Instance.creatComponentByStylename("trainer.vane.mainFrame.conentText");
         this._conent.text = LanguageMgr.GetTranslation("trainer.vane.mainFrame.conentText.text");
         addToContent(this._conent);
