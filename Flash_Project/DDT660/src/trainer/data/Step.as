package trainer.data
{
   ...
   public class Step
   {
      ...
      public static const INSECT_BALL_USE:int = 129;
      
      public static const ENCHANT_OPEN:int = 130;
      
      public static const SHOUSHI_GUIDE:int = 131;
      
      public static const CLOTHES_WEAPON_TIP:int = 132;
      
      public static const FIRST_ENTER_NESTTWO:int = 133;
      ...
      public function Step(id:int, exe:Function, pre:Function = null, fin:Function = null, millisecond:int = 0, isKey:Boolean = false)
      {
         ...
         if(millisecond != 0)
         {
            this.delay = millisecond / (1000 / this.FRAME_RATE);
         }
      }
