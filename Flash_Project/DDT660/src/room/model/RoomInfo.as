package room.model
{
	...
	public class RoomInfo extends EventDispatcher
	{
		...
		public static const TRANSNATIONALFIGHT_ROOM:int = 22;
		...
		public static const TREASURELOST_ROOM:int = 55;
		...
		public static const AnotherDimensionRoom:int = 65;
		
		public static const AnotherDimensionRoom2:int = 66;
		...
		public static const DUNGEONTYPE_AD:int = 3;
		...
		public var IsLastSession:Boolean = false;
		...
		public function updatePlaceState(param1:Array) : void
		{
			...
			var _loc3_:int = 0;
			var _loc4_:int = this.type == CHALLENGE_ROOM ? int(8) : int(4);
			var _loc5_:int = -100;
			var _loc6_:int = 0;
			while(_loc6_ < 10)
			{
			...
			switch(this._type)
			{
				...
				case RoomInfo.STONEEXPLORE_ROOM:
		...
		public function findPlayerByID(param1:int, param2:int = -1) : RoomPlayer
		{
			if(param2 == -1)
			{
				if(this._players[param1] && this._players[param1].playerInfo)
				{
					return this._players[param1] as RoomPlayer;
				}
				return null;
			}
			if(this._players[param1] && this._players[param1].playerInfo && this._players[param1].playerInfo.ZoneID == param2)
			{
				return this._players[param1] as RoomPlayer;
			}
			return null;
		...
		{
			return this.findPlayerByID(PlayerManager.Instance.Self.ID,PlayerManager.Instance.Self.ZoneID);
		}
		...
		{
			return this._type == DUNGEON_ROOM || this._type == MATCH_ROOM || this._type == ACADEMY_DUNGEON_ROOM || this._type == ACTIVITY_DUNGEON_ROOM || this._type == SPECIAL_ACTIVITY_DUNGEON || this._type == SCORE_ROOM || this._type == RANK_ROOM || this._type == FARM_BOSS || this._type == 47 || this._type == 48 || this._type == POLARREGION;
		}
		
		public function get isFarmBoss() : Boolean
		{
			return this._type == FARM_BOSS;
		}
		
		public function canShowTitle() : Boolean
		{
			return this._type >= 2 && this._type != 12 && this._type != 13 && this._type != RoomInfo.SINGLE_BATTLE;
		}
