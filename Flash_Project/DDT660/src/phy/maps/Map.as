package phy.maps
{
   ...
   public class Map extends Sprite
   {
      ...
      {
         param1 = param1 < 0 ? 0 : (param1 >= this._bound.width ? int(this._bound.width - 1) : param1);
         param2 = param2 < 0 ? 0 : param2;
         param3 = param2 + param3 >= this._bound.height ? int(this._bound.height - param2 - 1) : param3;
         var _loc4_:int = 0;
         while(_loc4_ < param3)
         {
      ...
      {
         param1 = param1 < 0 ? 0 : (param1 > this._bound.width ? int(this._bound.width) : param1);
         param2 = param2 < 0 ? 0 : param2;
         param3 = param2 + param3 > this._bound.height ? int(this._bound.height - param2) : param3;
         var _loc4_:int = 0;
         while(_loc4_ < param3)
         {
            if(!this.IsEmpty(param1 - 1,param2) || !this.IsEmpty(param1 + 1,param2))
	  ...
	  {
		  var phyO:PhysicalObj = null;
		  var temp:Array = new Array();
		  for each(phyO in this._phyicals)
		  {
