package fightLib.script.HighThrow
{
   ...
   public class DifficultHighThrow extends BaseScript
   {
      ...
      override protected function initializeScript() : void
      {
         ...
         var command2:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.HighThrow.DifficultHighThrow.command2"),LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.startTrain"),this.startTrain);
