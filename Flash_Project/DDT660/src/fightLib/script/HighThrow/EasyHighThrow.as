package fightLib.script.HighThrow
{
   ...
   public class EasyHighThrow extends BaseScript
   {
      ...
      private var _arr:Array = new Array(WeaponId.WeaponD,WeaponId.WeaponH,WeaponId.WeaponI);
      ...
      {
         var command1:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.HighThrow.EasyHighThrow.command1"),"",null,"",null,true,false,this._arr);
