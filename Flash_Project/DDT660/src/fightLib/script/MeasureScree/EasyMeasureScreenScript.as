package fightLib.script.MeasureScree
{
   ...
   public class EasyMeasureScreenScript extends BaseScript
   {
      ...
      {
         var command2:BaseFightLibCommand = new PopUpFrameWaitCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.EasyMeasureScreenScript.command2"),this.clearMaskAndArrow,null,null,null,null,false,false);
         command2.excuteFunArr.push(this.drawMaskAndWait);
