package fightLib.script.HighGap
{
   ...
   public class EasyHighGap extends BaseScript
   {
      ...
      {
         var command3:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.HighGap.EasyHighGap.command3"),LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.startTrain"),this.startTrain);
