package fightLib.script.HighGap
{
   ...
   public class NormalHighGap extends BaseScript
   {
      ...
      {
         var command1:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.HighGap.NormalHighGap.command1"),LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.startTrain"),this.startTrain);
