package fightLib.script.TwentyDegree
{
   ...
   public class EasyTwentyDegree extends BaseScript
   {
      ...
      private var _arr:Array = new Array(WeaponId.WeaponA,WeaponId.WeaponB,WeaponId.WeaponC,WeaponId.WeaponD,WeaponId.WeaponE,WeaponId.WeaponF);
      ...
      {
         var command1:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.EasyTwentyDegree.command1"),"",null,"",null,true,false,this._arr);
      ...
      {
         var commond:BaseFightLibCommand = null;
         if(_index < _commonds.length)
         {
            commond = _commonds[_index++];
            commond.excute();
         }
         else
         {
