package fightLib.script.TwentyDegree
{
   ...
   public class DifficultTwentyDegree extends BaseScript
   {
      ...
      override protected function initializeScript() : void
      {
         ...
         var command2:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.DifficultTwentyDegree.command2"),LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.MeasureScree.startTrain"),this.startTrain);
