package fightLib.script.SixtyDegree
{
   ...
   public class EasySixtyDegreeScript extends BaseScript
   {
      ...
      private var _arr:Array = new Array(WeaponId.WeaponH,WeaponId.WeaponG,WeaponId.WeaponD,WeaponId.WeaponI);
      ...
      {
         var command1:BaseFightLibCommand = new PopupFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.SixtyDegree.EasySixtyDegreeScript.command1"),"",null,"",null,true,false,this._arr);
