package fightLib.script
{
   ...
   public class FightLibGuideScripit extends BaseScript
   {
      ...
      {
         var command1:PopupHFrameCommand = new PopupHFrameCommand(LanguageMgr.GetTranslation("tank.command.fightLibCommands.script.FightLibGuideScripit.welcome"),LanguageMgr.GetTranslation("ok"),this.firstEnterFrameClose);
