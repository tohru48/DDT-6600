package fightLib.view
{
   ...
   public class FightLibPlayerInfoView extends Sprite implements Disposeable
   {
      ...
      {
         this._backgournd = ComponentFactory.Instance.creat("asset.fightlib.playerinfoViewbgImg");
         addChild(this._backgournd);
         ...
         this._reputeTitleField = ComponentFactory.Instance.creatComponentByStylename("fightLib.PlayerInfo.ReputeTitleField");
         this._reputeTitleField.text = LanguageMgr.GetTranslation("repute");
         addChild(this._reputeTitleField);
         ...
         this._gesteTitleField = ComponentFactory.Instance.creatComponentByStylename("fightLib.PlayerInfo.GesteTitleField");
         this._gesteTitleField.text = LanguageMgr.GetTranslation("offer");
         addChild(this._gesteTitleField);
         ...
         this._buff.boxSpacing = 10;
         PositionUtils.setPos(this._buff,"fightLib.PlyerInfo.BuffPos");
         addChild(this._buff);
      ...
      {
         if(Boolean(evt.changedProperties["Effectiveness"]) || Boolean(evt.changedProperties["DutyLevel"]) || Boolean(evt.changedProperties["ConsortiaName"]) || Boolean(evt.changedProperties["SpouseName"]) || Boolean(evt.changedProperties["Grade"]) || Boolean(evt.changedProperties["Repute"]))
         {
            this.update();
         }
      }
