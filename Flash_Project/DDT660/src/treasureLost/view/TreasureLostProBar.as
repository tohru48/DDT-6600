package treasureLost.view
{
   ...
   public class TreasureLostProBar extends FightPropBar
   {
      ...
      public function TreasureLostProBar(self:LocalPlayer, type:int)
      {
      ...
      private function __updateProp(event:BagEvent) : void
      {
         ...
         var count:int = this._selfInfo.PropBag.getItemCountByTemplateId(TreasureLostManager.NORMALBALL);
         (_cells[0] as CustomPropCell).setCount(count);
         this._lock0 = count <= 0;
         _cells[0].enabled = true;
         _cells[0].enabled = !this._lock0;
         var count2:int = this._selfInfo.PropBag.getItemCountByTemplateId(TreasureLostManager.ALLBALL);
      ...
      override public function enter() : void
      {
         ...
         info.TemplateID = TreasureLostManager.NORMALBALL;
         ...
         info2.TemplateID = TreasureLostManager.ALLBALL;
