package collectionTask.player
{
   ...
   public class CollectionTaskPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      public function CollectionTaskPlayerBase(playerInfo:PlayerInfo, callBack:Function = null)
      {
         super(callBack);
      ...
      private function sceneCharacterLoaderBodyNaturalCallBack(sceneCharacterLoaderBody:SceneCharacterLoaderBody, isAllLoadSucceed:Boolean) : void
      {
         var actionBmp:BitmapData = null;
