package escort.view
{
   ...
   public class EscortExitBtn extends Sprite implements Disposeable
   {
      ...
      {
         this._bg = ComponentFactory.Instance.creatBitmap("asset.escort.returnBtn.bg");
         this._moveOutBtn = ComponentFactory.Instance.creatComponentByStylename("escort.moveOutBtn");
         this._moveInBtn = ComponentFactory.Instance.creatComponentByStylename("escort.moveInBtn");
         this._returnBtn = ComponentFactory.Instance.creatComponentByStylename("escort.returnBtn");
         addChild(this._bg);
      ...
      {
         SoundManager.instance.play("008");
         var confirmFrame:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("escort.leaveGamePromptTxt"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,true,true,LayerManager.BLCAK_BLOCKGOUND);
