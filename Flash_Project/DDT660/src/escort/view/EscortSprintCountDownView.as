package escort.view
{
   ...
   public class EscortSprintCountDownView extends Sprite implements Disposeable
   {
      ...
      public function EscortSprintCountDownView()
      {
         super();
         this.x = 340;
         this.y = 34;
      ...
      private function initView() : void
      {
         ...
         this._recordTxt = LanguageMgr.GetTranslation("escort.frame.sprintCountDownViewTxt");
