package escort.view
{
   ...
   public class EscortBuffCountDownView extends Sprite implements Disposeable
   {
      ...
      public function EscortBuffCountDownView(endTime:Date, type:int, index:int)
      {
         super();
         if(type == 3)
         {
         ...
         this._type = type;
         this._bg = ComponentFactory.Instance.creatBitmap("asset.escort.buffCountDownBg");
         this._titleTxt = ComponentFactory.Instance.creatComponentByStylename("escort.game.buffTitleTxt");
         ...
         this._countDownTxt = ComponentFactory.Instance.creatComponentByStylename("escort.game.buffCountDownTxt");
         addChild(this._bg);
