package petsBag.view.item
{
   ...
   public class PetTip extends BaseTip
   {
      ...
      private function updateView() : void
      {
         ...
         this._attackTxt.text = this._info.Attack > 0 ? String(this._info.Attack) + "(" + growthText + (this._info.AttackGrow / PetconfigAnalyzer.PetCofnig.PropertiesRate).toFixed(1) + ")" : "";
         this._defenceTxt.text = this._info.Defence > 0 ? String(this._info.Defence) + "(" + growthText + (this._info.DefenceGrow / PetconfigAnalyzer.PetCofnig.PropertiesRate).toFixed(1) + ")" : "";
         this._agilityTxt.text = this._info.Agility > 0 ? String(this._info.Agility) + "(" + growthText + (this._info.AgilityGrow / PetconfigAnalyzer.PetCofnig.PropertiesRate).toFixed(1) + ")" : "";
         this._HPTxt.text = this._info.Blood > 0 ? String(this._info.Blood) + "(" + growthText + (this._info.BloodGrow / PetconfigAnalyzer.PetCofnig.PropertiesRate).toFixed(1) + ")" : "";
         this._luckTxt.text = this._info.Luck > 0 ? String(this._info.Luck) + "(" + growthText + (this._info.LuckGrow / PetconfigAnalyzer.PetCofnig.PropertiesRate).toFixed(1) + ")" : "";
