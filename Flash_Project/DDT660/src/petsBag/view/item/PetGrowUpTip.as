package petsBag.view.item
{
   ...
   public class PetGrowUpTip extends BaseTip
   {
      ...
      protected function updateView() : void
      {
         ...
         var attackRate:Number = this._info.AttackGrow / propertiesRate;
         this._attackTxt.text = this._info.Attack > 0 ? "(" + attackRate.toFixed(1) + ")" : "";
         var defenceRate:Number = this._info.DefenceGrow / propertiesRate;
         this._defenceTxt.text = this._info.Defence > 0 ? "(" + defenceRate.toFixed(1) + ")" : "";
         var agilityRate:Number = this._info.AgilityGrow / propertiesRate;
         this._agilityTxt.text = this._info.Agility > 0 ? "(" + agilityRate.toFixed(1) + ")" : "";
         this._HPTxt.text = this._info.Blood > 0 ? "(" + (this._info.BloodGrow / propertiesRate).toFixed(1) + ")" : "";
         var luckRate:Number = this._info.LuckGrow / propertiesRate;
         this._luckTxt.text = this._info.Luck > 0 ? "(" + luckRate.toFixed(1) + ")" : "";
         this.fixPos();
