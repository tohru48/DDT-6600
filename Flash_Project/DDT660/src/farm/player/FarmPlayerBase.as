package farm.player
{
   ...
   public class FarmPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      public function FarmPlayerBase(playerInfo:PlayerInfo, callBack:Function = null)
      {
         super(callBack);
      ...
      private function sceneCharacterLoaderBodyNaturalCallBack(sceneCharacterLoaderBody:FarmSceneCharacterLoaderLayer, isAllLoadSucceed:Boolean) : void
      {
         var actionBmp:BitmapData = null;
