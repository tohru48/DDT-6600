package farm.event
{
   ...
   public class FarmEvent extends Event
   {
      ...
      public static const FARMTREE_UPDATETREELEVEL:String = "farmTree_updateTreeLevel";
      
      public static const FARMPOULTRY_SETCALLBTN:String = "farmPoultry_setCallBtn";
      
      public static const FARMPOULTRY_UPGRADING:String = "farmPoultry_upgrading";
