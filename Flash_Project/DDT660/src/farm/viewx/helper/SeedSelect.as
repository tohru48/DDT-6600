   ...
   public class SeedSelect extends ChatBasePanel implements Disposeable
   {
      ...
      private function setList() : void
      {
         ...
         for(var i:int = 0; i < infoList.length; i++)
         {
            ...
            item.addEventListener(SelectComposeItemEvent.SELECT_SEED,this.__itemClick);
      ...
      private function __itemClick(event:SelectComposeItemEvent) : void
      {
         ...
         dispatchEvent(new SelectComposeItemEvent(SelectComposeItemEvent.SELECT_SEED,event.data));
      }
