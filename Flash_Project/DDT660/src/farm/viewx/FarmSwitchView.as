package farm.viewx
{
   ...
   public class FarmSwitchView extends BaseStateView
   {
      ...
      private function petFarmGuilde() : void
      {
         ...
         {
            PetBagController.instance().showPetFarmGuildArrow(ArrowType.OPEN_PET_BAG,50,"farmTrainer.openPetBagArrowPos","asset.farmTrainer.clickHere","farmTrainer.openPetBagTipPos",this);
         }
      }
