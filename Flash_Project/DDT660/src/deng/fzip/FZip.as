package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return this.addFileAt(Boolean(this.filesList) ? this.filesList.length : 0,param1,param2,param3);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8", param4:Boolean = true) : FZipFile
      {
         return this.addFileFromStringAt(Boolean(this.filesList) ? this.filesList.length : 0,param1,param2,param3,param4);
      }
