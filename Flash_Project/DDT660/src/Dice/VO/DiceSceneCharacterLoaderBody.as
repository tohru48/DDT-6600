package Dice.VO
{
   ...
   public class DiceSceneCharacterLoaderBody
   {
      ...
      public function DiceSceneCharacterLoaderBody(playerInfo:PlayerInfo)
      {
         super();
      ...
      {
         this._loaders = new Vector.<DiceSceneCharacterLayer>();
         this._recordStyle = this._playerInfo.Style.split(",");
         this._recordColor = this._playerInfo.Colors.split(",");
         this._loaders.push(new DiceSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex));
         this._loaders.push(new DiceSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex));
      }
