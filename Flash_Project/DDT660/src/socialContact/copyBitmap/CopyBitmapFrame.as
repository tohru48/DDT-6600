package socialContact.copyBitmap
{
   ...
   public class CopyBitmapFrame extends Sprite
   {
      ...
      public function CopyBitmapFrame(mode:CopyBitmapMode)
      {
         super();
         this._mode = mode;
         this._init();
      ...
      private function _init() : void
      {
         ...
         {
            this._pointViewArr[i] = this._buildPointView();
            this._pointViewArr[i].buttonMode = true;
         }
      ...
      private function _buildPointView() : Sprite
      {
         ...
         newSprite.graphics.beginFill(16711935);
         newSprite.graphics.drawRect(-5,-5,10,10);
         return newSprite;
      }
      ...
      private function _stageStartDown(e:MouseEvent) : void
      {
      ...
      private function _stageStartUp(e:MouseEvent) : void
      {
      ...
      private function _addEvt() : void
      {
         for(var i:int = 0; i < 8; i++)
         {
            this._pointViewArr[i].addEventListener(MouseEvent.MOUSE_DOWN,this._pointViewDown);
         }
      ...
      private function _areaViewDown(e:MouseEvent) : void
      {
      ...
      private function _areaViewUp(e:MouseEvent) : void
      {
         this._areaView.removeEventListener(Event.ENTER_FRAME,this._areaViewMove);
      }
      
      private function _areaViewMove(e:Event) : void
      {
      ...
      private function _pointViewDown(e:MouseEvent) : void
      {
         this._mode.ponitID = this._pointViewArr.indexOf(e.currentTarget as Sprite);
         this._nowPonitView = Sprite(e.currentTarget);
      ...
      private function _upDataView(e:Event) : void
      {
      ...
      private function _clickCancelBt(e:MouseEvent) : void
      {
         CopyBitmapManager.Instance.close();
      }
      
      private function _clickOkBt(e:MouseEvent) : void
      {
         this.visible = false;
      ...
      public function dispose() : void
      {
         ...
         for(var i:int = 0; i < this._pointViewArr.length; i++)
         {
            if(this._pointViewArr[i] != null)
            {
               removeChild(this._pointViewArr[i]);
            }
            this._pointViewArr[i] = null;
         }
      ...
      private function kelisTest() : void
      {
         ...
         clickKelis = function(e:MouseEvent):void
         {
