package gemstone.views
{
   ...
   public class GemstoneCurInfo extends Sprite implements Disposeable
   {
      ...
      public function update(obj:Object) : void
      {
         ...
         this._pdescriptTxt1.text = String(obj.curLve);
         this._pdescriptTxt3.text = String(obj.upGrdPro);
         this._pZbZhidescriptTxt1.text = String(obj.levHe);
         this._pZbZhidescriptTxt.text = String(obj.proHe);
      }
