package consortion.view.selfConsortia
{
   ...
   public class ConsortionTrasferFrame extends Frame
   {
      ...
      private function __okHandler(event:MouseEvent) : void
      {
         ...
         this._ok.enable = false;
         for each(info in ConsortionModelControl.Instance.model.memberList)
         {
            if(info.NickName == this._input.text)
            {
               ...
               if(info.Grade < CreateConsortionFrame.MIN_CREAT_CONSROTIA_LEVEL)
               {
