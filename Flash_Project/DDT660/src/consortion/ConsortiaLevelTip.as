package consortion
{
   ...
   public class ConsortiaLevelTip extends BaseTip
   {
      ...
      private function drawBG($width:int = 0) : void
      {
         this.reset();
         this._bg.width = 350;
         this._bg.height = this._consumptionText2.y + this._consumptionText2.textHeight + 30;
