package store.view.strength
{
   ...
   public class BuyGiftBagButton extends BuyItemButton
   {
      ...
      public static const GIFTBAG_PRICE:int = 998;
      ...
      override protected function __onMouseClick(event:MouseEvent) : void
      {
         ...
         if(_enable)
         {
            ...
            alert1 = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("store.view.strength.buyGift"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,true,false,LayerManager.ALPHA_BLOCKGOUND);
