package sevenDouble.view
{
   ...
   public class SevenDoubleStartCountDownView extends Sprite implements Disposeable
   {
      ...
      public function SevenDoubleStartCountDownView(callFunction:Function, callParams:Array)
      {
         ...
         this._mc = ComponentFactory.Instance.creat("asset.sevenDouble.gameStartCountDown");
         addChild(this._mc);
