package hall.player
{
   ...
   public class HallSceneCharacterLoaderLayer
   {
      ...
      public function HallSceneCharacterLoaderLayer(playerInfo:PlayerInfo, sceneCharacterLoaderType:int = 0)
      {
         super();
      ...
      {
         this._loaders = new Vector.<HallSceneCharacterLayer>();
         this._recordStyle = this._playerInfo.Style.split(",");
         this._recordColor = this._playerInfo.Colors.split(",");
         this._loaders.push(new HallSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex,this._sceneCharacterLoaderType,this._playerInfo.MountsType));
         this._loaders.push(new HallSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex,this._sceneCharacterLoaderType,this._playerInfo.MountsType));
      }
