   ...
   public class ParticleManager
   {
      ...
      public static function initPartical(param1:String, param2:String = null) : void
      {
         ...
         if(!_ready && param1 != null)
         {
            ...
            _loc5_ = LoadResourceManager.Instance.createLoader(_loc3_,BaseLoader.TEXT_LOADER);
            _loc5_.addEventListener(LoaderEvent.COMPLETE,__loadComplete);
            LoadResourceManager.Instance.startLoad(_loc5_);
            _loc6_ = LoadResourceManager.Instance.createLoader(_loc4_,BaseLoader.MODULE_LOADER,null,"GET",Domain);
      ...
      private static function save() : XML
      {
         ...
         for each(_loc2_ in list)
         {
            ...
            for each(_loc4_ in _loc2_.particales)
            {
               ...
               if(Boolean(_loc4_.lifeEasing.colorLine))
               {
