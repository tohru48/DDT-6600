package par.enginees
{
   ...
   public class ParticleEnginee
   {
      ...
      {
         param1.initialize();
         var _loc2_:uint = param1.info.displayCreator;
      ...
      {
         if(Boolean(this.spareParticles[param1.displayCreator]) && this.spareParticles[param1.displayCreator].length > 0)
         {
            return this.spareParticles[param1.displayCreator].shift();
         }
