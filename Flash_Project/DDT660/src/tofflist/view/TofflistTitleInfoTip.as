package tofflist.view
{
   ...
   public class TofflistTitleInfoTip extends Sprite implements ITransformableTip
   {
      ...
      {
         this._bg = ComponentFactory.Instance.creatComponentByStylename("tofflist.titleTips.bg");
         addChild(this._bg);
         this._leftView = new TofflistTitleInfoItem();
         addChild(this._leftView);
         this._rightView = new TofflistTitleInfoItem();
         PositionUtils.setPos(this._rightView,"tofflist.tips.rightViewPos");
