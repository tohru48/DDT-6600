package littleGame.model
{
   ...
   public class LittleLiving extends EventDispatcher
   {
      ...
      private var _pos:Point = new Point(400,400);
      ...
      protected var _actionMgr:LittleActionManager = new LittleActionManager();
      ...
      public function LittleLiving(id:int, x:int, y:int, type:int, modelID:String = null)
      {
         ...
         this.ddt_internal::_modelID = modelID;
         this._type = type;
         super();
      }
      ...
      public function stand() : void
      {
         ...
         for each(action in this._actionMgr.ddt_internal::_queue)
         {
