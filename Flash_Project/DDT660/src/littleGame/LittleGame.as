package littleGame
{
   ...
   public class LittleGame extends BaseStateView
   {
      ...
      private function configUI() : void
      {
         ...
         SoundManager.instance.allowSound = CharacterSoundManager.instance.allowSound = this._game.soundEnabled ? SharedManager.Instance.allowSound : false;
         SoundManager.instance.allowMusic = CharacterSoundManager.instance.allowMusic = this._game.soundEnabled ? SharedManager.Instance.allowMusic : false;
         this._soundButton.state = this._game.soundEnabled ? 1 : 2;
         this._inhaleNote = ComponentFactory.Instance.creat("asset.littleGame.InhaleNote");
         this._inhaleNote.x = 242;
