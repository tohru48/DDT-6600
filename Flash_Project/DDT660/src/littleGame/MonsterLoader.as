package littleGame
{
   ...
   public class MonsterLoader extends EventDispatcher implements Disposeable
   {
      ...
      public function startup() : void
      {
         ...
         {
            loader = LoadResourceManager.Instance.createLoader(PathManager.solveASTPath(monster),BaseLoader.BYTE_LOADER);
      ...
      private function __dataComplete(event:Event) : void
      {
         ...
         var idx:int = int(this._loaders.indexOf(dataLoader));
         if(idx >= 0)
         {
