package quest
{
   ...
   public class TaskPannelStripView extends Sprite
   {
      ...
      private var _style:int = TaskMainFrame.NORMAL;
      ...
      private function initView() : void
      {
         ...
         this._bg.setFrame(1);
         addChild(this._bg);
         this._light = ComponentFactory.Instance.creatComponentByStylename("asset.core.quest.QuestItemLight");
         ...
         this._trusteeshipTxtImg = ComponentFactory.Instance.creat("asset.trusteeship.textImg");
         this._trusteeshipTxtImg.visible = false;
         addChild(this._trusteeshipTxtImg);
      ...
      public function update() : void
      {
         ...
         {
            this.bmpOK.visible = false;
            if(Boolean(TrusteeshipManager.instance.getTrusteeshipInfo(this._info.id)))
            {
               this._trusteeshipTxtImg.visible = true;
            }
            else
            {
               this._trusteeshipTxtImg.visible = false;
      ...
      public function dispose() : void
      {
         ...
         this.bmpOK = null;
         if(Boolean(this._trusteeshipTxtImg))
         {
            ObjectUtils.disposeObject(this._trusteeshipTxtImg);
         }
         this._trusteeshipTxtImg = null;
