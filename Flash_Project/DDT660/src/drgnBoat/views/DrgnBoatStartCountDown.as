package drgnBoat.views
{
   ...
   public class DrgnBoatStartCountDown extends Sprite implements Disposeable
   {
      ...
      public function DrgnBoatStartCountDown(callFunction:Function, callParams:Array)
      {
         super();
         PositionUtils.setPos(this,"drgnBoat.gameStart.countDownViewPos");
         this._func = callFunction;
         this._funcParams = callParams;
         this._mc = ComponentFactory.Instance.creat("drgnBoat.gameStartCountDown");
         addChild(this._mc);
