package drgnBoat.views
{
   ...
   public class DrgnBoatCountDown extends Sprite implements Disposeable
   {
      ...
      public function DrgnBoatCountDown()
      {
         super();
         this.x = 260;
         this.initView();
      ...
      private function initView() : void
      {
         ...
         this._recordTxt = LanguageMgr.GetTranslation("drgnBoat.frame.countDownViewTxt");
