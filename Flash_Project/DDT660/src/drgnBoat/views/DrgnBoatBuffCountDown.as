package drgnBoat.views
{
   ...
   public class DrgnBoatBuffCountDown extends Sprite implements Disposeable
   {
      ...
      public function DrgnBoatBuffCountDown(endTime:Date, type:int, index:int)
      {
         super();
         if(type == 3)
         {
         ...
         this._type = type;
         this._bg = ComponentFactory.Instance.creatBitmap("drgnBoat.buffCountDownBg");
         this._titleTxt = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.game.buffTitleTxt");
         this._titleTxt.text = LanguageMgr.GetTranslation("escort.game.buffTitleTxt" + this._type);
         this._titleTxt.textColor = this.colorList[this._type - 1];
         this._countDownTxt = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.game.buffCountDownTxt");
         addChild(this._bg);
