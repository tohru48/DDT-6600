package drgnBoat.views
{
   ...
   public class DrgnBoatExitBtn extends Sprite implements Disposeable
   {
      ...
      {
         this._bg = ComponentFactory.Instance.creatBitmap("drgnBoat.returnBtn.bg");
         this._moveOutBtn = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.moveOutBtn");
         this._moveInBtn = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.moveInBtn");
         this._returnBtn = ComponentFactory.Instance.creatComponentByStylename("drgnBoat.returnBtn");
         addChild(this._bg);
      ...
      {
         SoundManager.instance.play("008");
         var confirmFrame:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("drgnBoat.leaveGamePromptTxt"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,true,true,LayerManager.BLCAK_BLOCKGOUND);
