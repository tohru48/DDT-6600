package ddt.view.tips
{
   ...
   public class BuffTip extends BaseTip
   {
      ...
      override public function set tipData(data:Object) : void
      {
         ...
         {
            this.visible = true;
            this.setShow(data.isActive,data.isFree,data.day,data.hour,data.min,data.describe);
         }
         else
         {
            this.visible = false;
      ...
      protected function setShow(isActive:Boolean, isFree:Boolean, day:int, hour:int, min:int, describe:String) : void
      {
         ...
         if(isActive)
         {
            ...
            else
            {
               ...
               this.day_txt.text = String(day);
               this.hour_txt.text = String(hour);
               this.min_txt.text = String(min);
         ...
         {
            this.describe_txt.text = describe;
      ...
      protected function updateWH() : void
      {
         ...
         if(Boolean(this._tempData.isActive))
         {
            ...
            {
               wid1 = int(Math.abs(this.name_txt.x) * 2 + this.name_txt.width);
               wid2 = int(this.day_txt.x + this.day_txt.width + this.name_txt.x);
               this._bg.width = wid1 > wid2 ? wid1 : wid2;
            }
            else
            {
               this._bg.width = int(this.min_txt.x + this.min_txt.width + this.mins_txt.width + 10);
            }
      ...
      {
         this.days_txt.visible = !bol;
         this.hours_txt.visible = !bol;
         this.hour_txt.visible = !bol;
         this.mins_txt.visible = !bol;
         this.min_txt.visible = !bol;
      }
   }
}
