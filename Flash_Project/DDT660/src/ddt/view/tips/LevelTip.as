package ddt.view.tips
{
   ...
   public class LevelTip extends BaseTip implements ITip
   {
      ...
      private function makeTip(obj:Object) : void
      {
         if(Boolean(obj))
         {
            this.resetLevelTip(obj.Level,obj.Repute,obj.Win,obj.Total,obj.Battle,obj.exploit,obj.enableTip,obj.team);
         }
      }
      
      private function resetLevelTip(lv:int, repute:int, win:int, total:int, battle:int, exploit:int, enableTip:Boolean = true, team:int = 1) : void
      {
         this._level = lv;
         ...
         if(StateManager.currentStateType == StateType.FIGHTING || StateManager.currentStateType == StateType.TRAINER1 || StateManager.currentStateType == StateType.TRAINER2 || StateManager.currentStateType == StateType.FIGHT_LIB_GAMEVIEW || StateManager.currentStateType == StateType.GAME_LOADING)
         {
      ...
      {
         this._repute.level = level;
         this._repute.setRepute(reputeCount);
      }
      ...
      {
         this._exploit.exploitNum = value;
      }
