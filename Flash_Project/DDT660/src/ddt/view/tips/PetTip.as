   ...
   public class PetTip extends BaseTip
   {
      ...
      override public function set tipData(data:Object) : void
      {
         if(Boolean(data))
         {
            ...
            _tipData = data;
            this._petName.text = String(data["petName"]);
            this._petLevel.text = "Lv." + String(data["petLevel"]);
            this._petIcon = new BitmapLoaderProxy(PathManager.solvePetIconUrl(String(data["petIconUrl"])),new Rectangle(0,0,PET_ICON_SIZE,PET_ICON_SIZE),true);
