package ddt.view.character
{
   ...
   public class GameLayer extends BaseLayer
   {
      ...
      {
         return PathManager.solveGoodsPath(_info.CategoryID,_pic,_info.NeedSex == 1,BaseLayer.GAME,_hairType,String(layer),info.Level,_gunBack,int(_info.Property1),this._state);
      }
   }
}
