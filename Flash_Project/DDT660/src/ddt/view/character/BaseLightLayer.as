package ddt.view.character
{
   ...
   public class BaseLightLayer extends Sprite implements ILayer
   {
      ...
      private function getId() : String
      {
         ...
         var nimbus:String = this._nimbus.toString();
         nimbus = nimbus.substr(nimbus.length - 2,nimbus.length);
         return Number(nimbus).toString();
      }
      ...
      protected function __sourceComplete(event:LoaderEvent = null) : void
      {
         ...
         {
            LightClass = ClassUtils.uiSourceDomain.getDefinition("game.crazyTank.view.light.CircleLightAsset_" + this.getId()) as Class;
