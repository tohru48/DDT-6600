package ddt.view.common
{
   ...
   public class GradientText extends Sprite implements Disposeable
   {
      ...
      public function GradientText(field:FilterFrameText, randomColor:Array = null)
      {
         ...
         this.randomColor = Boolean(randomColor) ? randomColor : RandomColors;
      ...
      {
         this._field.text = s;
         this.render(randerColor,randerFont);
      }
      ...
      private function drawBox() : void
      {
         ...
         this.graidenBox.graphics.beginGradientFill(GradientType.LINEAR,this.currentColors,alphas,ratios,this.currentMatix);
      ...
      {
         var cs:Array = [];
         cs = this.randomColor[int(Math.random() * 10000 % 16)];
         var c1:int = int(cs[0]);
         var c2:int = int(cs[1]);
         return [c1,c2];
      }
      ...
      {
         this._textFormat.font = ftName;
         var addFontSize:int = this.getRandomFontSize();
         switch(ftName)
         {
            case "AdLib BT":
               this._textFormat.size = 16 + addFontSize;
               this._field.x = 5.5;
               this._field.y = 3.5;
               break;
            case "Arial Black":
               this._textFormat.size = 18 + addFontSize;
               this._field.x = 5.2;
               this._field.y = 0.4;
               break;
            case "VAG Rounded Std Thin":
               ...
               break;
            case "Britannic Bold":
               this._textFormat.size = 19 + addFontSize;
               this._field.x = 5.9;
               this._field.y = 2.7;
               break;
            case "Berlin Sans FB Demi":
               this._textFormat.size = 21 + addFontSize;
               this._field.x = 5.4;
               this._field.y = 0.3;
               break;
            case "Benguiat Bk BT":
            ...
            case "Tw Cen MT Condensed Extra Bold":
               this._textFormat.size = 20 + addFontSize;
               this._field.x = 7.7;
               this._field.y = 1.7;
               break;
