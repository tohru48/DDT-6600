package ddt.utils
{
	...
	public class Helpers
	{
		...
		public static function getTimeString(param1:Number, param2:String = "") : String
		{
			...
			_loc3_ = String(Math.floor(param1 / 1000 % 60));
			_loc4_ = String(Math.floor(param1 / 60000 % 60));
			_loc5_ = String(Math.floor(param1 / 3600000 % 60));
			_loc3_ = fixZero(_loc3_);
			_loc4_ = fixZero(_loc4_);
			_loc5_ = fixZero(_loc5_);
