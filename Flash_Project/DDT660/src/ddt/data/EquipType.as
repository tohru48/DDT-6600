package ddt.data
{
	...
	public class EquipType
	{
		...
		public static const TREASURELOST_POWER:int = 201520;
		...
		public static const TrueAngle2:int = 17102;
		...
		public static const EVERYDAYGIFTRECORD:int = 70;
		...
		public static function isEditable(param1:ItemTemplateInfo) : Boolean
		{
			...
			var cat:int = param1.CategoryID;
			var prop:String = param1.Property6;
			
			if(cat >= 1 && cat <= 6 && prop != null && prop == "0")
				return true;
		...
		public static function canBeUsed(param1:ItemTemplateInfo) : Boolean
		{
			...
			if(param1.CategoryID == EquipType.HOME_ADORN)
			{
				return true;
			}
			switch(param1.TemplateID)
			{
				...
				case EquipType.HORSE_UP_ITEM:
				case EquipType.HORSE_SKILL_UP_ITEM:
				case EquipType.ZODIACCARD:
				case EquipType.LOVE_CHOCOLATE:
				case EquipType.FEELINGLY:
				case EquipType.RANDOM_SUIT:
					return true;
				default:
					return false;
			}
		...
		{
			return param1.CategoryID == UNFRIGHTPROP && (param1.Property1 == "26" || param1.Property1 == "110");
		}
		...
		public static function isBelongToPropBag(param1:ItemTemplateInfo) : Boolean
		{
			...
			switch(param1.CategoryID)
			{
				...
				case EquipType.TASK:
				case EquipType.TEXP:
				case EquipType.MAGIC_TEXP:
				case EquipType.TEXP_TASK:
				case EquipType.ACTIVE_TASK:
				case EquipType.FOOD:
				case EquipType.PET_EGG:
				case EquipType.FUZHUDAOJU:
				case EquipType.CALL_CARD:
					return true;
				default:
					return false;
			}
		...
		public static function isPetEgg(item:ItemTemplateInfo) : Boolean
		{
			return item.CategoryID == EquipType.PET_EGG;
		}
		...
		public static function isValuableEquip(param1:ItemTemplateInfo) : Boolean
		{
			...
			if(_loc2_)
			{
				...
				_loc3_ = EnchantManager.instance.infoVec.length;
		...
		{
			return param1.TemplateID == Angle || param1.TemplateID == TrueAngle || param1.TemplateID == ExllenceAngle || param1.TemplateID == FlyAngle || param1.TemplateID == FlyAngleI || param1.TemplateID == ExllenceAngleII || param1.TemplateID == ExllenceAngleI;
		}
		...
		public static function filterEquiqItemId(param1:int) : int
		{
			...
			{
				case -1:
					param1 = EquipType.CUCAO;
					break;
				case -2:
					param1 = EquipType.PUTONG;
					break;
				case -3:
					param1 = EquipType.YOUXIU;
					break;
				case -4:
					param1 = EquipType.JINGLIANG;
			}
			return param1;
		}
