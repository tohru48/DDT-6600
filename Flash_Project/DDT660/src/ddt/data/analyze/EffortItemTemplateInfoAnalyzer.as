package ddt.data.analyze
{
   ...
   public class EffortItemTemplateInfoAnalyzer extends DataAnalyzer
   {
      ...
      override public function analyze(data:*) : void
      {
         ...
         var conditions:XMLList = null;
         var j:int = 0;
         var rewards:XMLList = null;
         var k:int = 0;
         var effortQualificationInfo:EffortQualificationInfo = null;
         var effortRewardInfo:EffortRewardInfo = null;
         ...
         if(xml.@value == "true")
         {
            ...
            for(i = 0; i < xmllist.length(); i++)
            {
               ...
               effortInfo.IsOther = this.getBoolean(x.@IsOther);
               effortInfo.AchievementType = x.@AchievementType;
               effortInfo.CanHide = this.getBoolean(x.@CanHide);
               ...
               this.list[effortInfo.ID] = effortInfo;
            }
            onAnalyzeComplete();
         }
         else
