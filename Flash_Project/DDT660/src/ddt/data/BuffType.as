package ddt.data
{
   public class BuffType
   {
      ...
      public static function isContainerBuff(buff:FightBuffInfo) : Boolean
      {
         return buff.type == Pay || buff.type == CONSORTIA || buff.type == CARD_BUFF;
      }
      
      public static function isActivityDunBuff(buff:FightBuffInfo) : Boolean
      {
         return buff.displayid == ActivityDungeonBubble || buff.displayid == ActivityDungeonNet;
      }
      
      public static function isPayBuff(buff:FightBuffInfo) : Boolean
      {
         return buff.id >= 50 && buff.id <= 79;
      }
