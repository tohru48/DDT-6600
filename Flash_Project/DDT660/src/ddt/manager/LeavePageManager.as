package ddt.manager
{
   ...
   public class LeavePageManager
   {
      ...
      {
         var redirictURL:String = "function redict () {top.location.href=\"" + PathManager.solveClientDownloadPath() + "\"}";
         ExternalInterface.call(redirictURL);
      }
      ...
      public static function showFillFrame() : BaseAlerFrame
      {
         ...
         frame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("tank.view.comon.lack"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),true,false,false,2);
      ...
      public static function leaveToFillPath() : void
      {
         ...
         else
         {
            ...
            if(DDT._fbapp)
            {
               navigateToURL(new URLRequest(encodeURI(PathManager.solveFillFbapp())),"_blank");
            }
            else
            {
      ...
      {
         var jsFunStr:String = null;
         var jsFunName:String = null;
         var paramArr:Array = null;
      ...
      private static function chargeMoney() : void
      {
         ...
         args["money"] = 10000;
         var moneyLoader:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ChargeMoneyForTest.ashx"),BaseLoader.REQUEST_LOADER,args);
