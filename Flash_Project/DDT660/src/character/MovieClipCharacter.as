package character
{
	...
	public class MovieClipCharacter extends Sprite implements ICharacter
	{
		...
		for(var _loc3_:int = 0,var _loc4_:* = actions; §§hasnext(_loc4_,_loc3_); a = new MovieClipAction(resource,action.@name,action.@next,action.@priority),a.endStop = String(action.@endStop) == "true",a.sound = action.@sound,this._actionSet.addAction(a))
		{
