package beadSystem.views
{
   ...
   public class OpenHoleNumAlertFrame extends BaseAlerFrame
   {
      ...
      private function initView() : void
      {
         ...
         this._alertInfo = new AlertInfo(LanguageMgr.GetTranslation("store.Embed.batchOpenHoleTileText"),LanguageMgr.GetTranslation("ok"),"",true,false);
         ...
         var stoneInfo:ItemTemplateInfo = ItemManager.Instance.getTemplateById(this.curItemID);
         ...
         this.maxLimit = bagInfo.getItemCountByTemplateId(this.curItemID);
         ...
         this._descript.text = LanguageMgr.GetTranslation("store.Embed.batchOpenHoleText");
