package church.view.churchFire
{
   ...
   public class ChurchFireItemView extends Sprite implements Disposeable
   {
      ...
      public function ChurchFireItemView(fireTemplateID:int, fireIcon:Bitmap)
      {
         super();
         this._fireIcon = fireIcon;
         this.fireTemplateID = fireTemplateID;
         this.initialize();
      }
      ...
      public function set fireIcon(value:Bitmap) : void
      {
         this._fireIcon = value;
      }
