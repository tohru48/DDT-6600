package church.view.churchFire
{
   ...
   public class ChurchFireCell extends BaseCell implements Disposeable
   {
      ...
      public function ChurchFireCell(bg:DisplayObject, $shopItemInfo:ShopItemInfo, TemplateID:int)
      {
         ...
         this._shopItemInfo = $shopItemInfo;
         this._fireTemplateID = TemplateID;
         this.initialize();
      }
      ...
      {
         var bgPos:Point = null;
         addChildAt(_bg,0);
         bgPos = ComponentFactory.Instance.creatCustomObject("church.ChurchFireCell.bgPos");
         _bg.x = bgPos.x;
         _bg.y = bgPos.y;
