package church.player
{
   ...
   public class ChurchPlayerBase extends SceneCharacterPlayerBase
   {
      ...
      public function ChurchPlayerBase(playerInfo:PlayerInfo, callBack:Function = null)
      {
         super(callBack);
      ...
      private function showDefaultCharacter() : void
      {
         ...
         actionBmp = new BitmapData(this.playerWitdh,this.playerHeight,true,0);
         actionBmp.copyPixels(this._headBitmapData,this._rectangle,new Point(25,20));
         this._defaultSceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontHead","NaturalFrontAction",actionBmp,1,1,this.playerWitdh,this.playerHeight,1));
      ...
      private function sceneCharacterStateNatural() : void
      {
         ...
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontHead","NaturalFrontAction",actionBmp,1,1,this.playerWitdh,this.playerHeight,1,points,true,7));
         ...
         actionBmp = new BitmapData(this.playerWitdh,this.playerHeight,true,0);
         actionBmp.copyPixels(this._headBitmapData,this._rectangle,new Point(0,0));
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontEyesCloseHead","NaturalFrontEyesCloseAction",actionBmp,1,1,this.playerWitdh,this.playerHeight,2));
         this._rectangle.x = this.playerWitdh * 2;
         this._rectangle.y = 0;
         this._rectangle.width = this.playerWitdh;
         this._rectangle.height = this.playerHeight;
         actionBmp = new BitmapData(this.playerWitdh,this.playerHeight * 2,true,0);
         actionBmp.copyPixels(this._headBitmapData,this._rectangle,new Point(0,0));
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalBackHead","NaturalBackAction",actionBmp,1,1,this.playerWitdh,this.playerHeight,6,points,true,7));
         this.sceneCharacterLoadBodyNatural();
      }
      
      private function sceneCharacterLoadBodyNatural() : void
      {
         var _sceneCharacterLoaderPath:String = null;
         if(ChurchManager.instance.isAdmin(this._playerInfo))
         {
            _sceneCharacterLoaderPath = "default";
         }
         else
         {
            _sceneCharacterLoaderPath = "cloth1";
         }
         this._sceneCharacterLoaderBody = new SceneCharacterLoaderBody(this._playerInfo,_sceneCharacterLoaderPath);
      ...
      private function sceneCharacterLoaderBodyNaturalCallBack(sceneCharacterLoaderBody:SceneCharacterLoaderBody, isAllLoadSucceed:Boolean = true) : void
      {
         ...
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontBody","NaturalFrontAction",actionBmp,1,7,this.playerWitdh,this.playerHeight,3));
         this._rectangle.x = 0;
         this._rectangle.y = 0;
         this._rectangle.width = this.playerWitdh;
         this._rectangle.height = this.playerHeight;
         actionBmp = new BitmapData(this.playerWitdh,this.playerHeight,true,0);
         actionBmp.copyPixels(this._bodyBitmapData,this._rectangle,new Point(0,0));
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontEyesCloseBody","NaturalFrontEyesCloseAction",actionBmp,1,1,this.playerWitdh,this.playerHeight,4));
         this._rectangle.x = 0;
         ...
         actionBmp = new BitmapData(this._bodyBitmapData.width,this.playerHeight,true,0);
         actionBmp.copyPixels(this._bodyBitmapData,this._rectangle,new Point(0,0));
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalBackBody","NaturalBackAction",actionBmp,1,7,this.playerWitdh,this.playerHeight,5));
