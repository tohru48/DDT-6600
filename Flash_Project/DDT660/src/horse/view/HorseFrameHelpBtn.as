package horse.view
{
   ...
   public class HorseFrameHelpBtn extends Sprite implements Disposeable
   {
      
      private var _btn:SimpleBitmapButton;
      
      public function HorseFrameHelpBtn()
      {
         super();
         this._btn = ComponentFactory.Instance.creatComponentByStylename("horse.frame.helpBtn");
         addChild(this._btn);
      ...
      private function clickHandler(event:MouseEvent) : void
      {
         ...
         var helpBd:DisplayObject = ComponentFactory.Instance.creat("horse.frame.HelpPrompt");
         var helpPage:HelpFrame = ComponentFactory.Instance.creat("horse.frame.HelpFrame");
