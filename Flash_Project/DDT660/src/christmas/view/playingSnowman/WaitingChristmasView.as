package christmas.view.playingSnowman
{
   ...
   public class WaitingChristmasView extends Component
   {
      ...
      private function initView() : void
      {
         ...
         this._loadingText = ComponentFactory.Instance.creatComponentByStylename("catchInsect.WaitingView.loadingText");
         this._loadingText.text = this._loadingArr[0];
         this._timeText = ComponentFactory.Instance.creatComponentByStylename("catchInsect.WaitingView.timeText");
