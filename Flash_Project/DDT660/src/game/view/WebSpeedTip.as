package game.view
{
   ...
   public class WebSpeedTip extends BaseTip
   {
      ...
      override public function set tipData(data:Object) : void
      {
         ...
         {
            this._stateTxt.htmlText = "<font color=\'#00FF33\'>" + data.stateTxt + "</font>";
            this._delayTxt.htmlText = "<font color=\'#00FF33\'>" + data.delayTxt + "</font>";
         }
         else if(data.stateTxt == WebSpeedInfo.BETTER)
         {
            this._stateTxt.htmlText = "<font color=\'#cc9900\'>" + data.stateTxt + "</font>";
            this._delayTxt.htmlText = "<font color=\'#cc9900\'>" + data.delayTxt + "</font>";
         }
         else if(data.stateTxt == WebSpeedInfo.WORST)
         {
            this._stateTxt.htmlText = "<font color=\'#ff0000\'>" + data.stateTxt + "</font>";
            this._delayTxt.htmlText = "<font color=\'#ff0000\'>" + data.delayTxt + "</font>";
         }
         this._fpsTxt.text = data.fpsTxt;
         this._explain1.text = data.explain1;
         this._explain2.htmlText = data.explain2;
         this.drawBG();
      }
