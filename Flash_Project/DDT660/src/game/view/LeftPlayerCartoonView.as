package game.view
{
   ...
   import room.transnational.NationField;
   ...
   public class LeftPlayerCartoonView extends Sprite implements Disposeable
   {
      ...
      private var _nationField:NationField;
      ...
      {
         if(RoomManager.Instance.current.type != 5 && RoomManager.Instance.current.type != RoomInfo.ACTIVITY_DUNGEON_ROOM && this._info && this._info.playerInfo && Boolean(this._info.playerInfo.currentPet) && this._info.playerInfo.currentPet.IsEquip)
         {
            ...
            if(RoomManager.Instance.current.type == RoomInfo.TRANSNATIONALFIGHT_ROOM && this._info.playerInfo.isSelf)
            {
               this._roomPlayerItemPet.updateView(this._info.playerInfo.snapPet);
            }
            else
            {
            ...
            {
               if(Boolean(this._nationField))
               {
                  this._nationField.parent.removeChild(this._nationField);
               }
               this._nationField = ComponentFactory.Instance.creat("ddt.room.transnational.NationField");
               this._nationField.setNationId(this._info.playerInfo.flagID);
               addChild(this._nationField);
            }
            else if(Boolean(this._nationField))
            {
               this._nationField.parent.removeChild(this._nationField);
               this._nationField.dispose();
            }
         }
         else
         {
      ...
      public function set info(living:Living) : void
      {
         ...
         var needEasingOut:Boolean = this._info != null;
         if(this._info != living)
         {
