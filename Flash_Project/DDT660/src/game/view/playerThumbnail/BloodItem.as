package game.view.playerThumbnail
{
   ...
   public class BloodItem extends Sprite implements Disposeable
   {
      ...
      public function BloodItem(currentBlood:int, totalBlood:int, team:int = 2)
      {
         super();
         ...
         if(team == 1)
         {
            this._HPStrip = ComponentFactory.Instance.creatBitmap("fightFootballTime.game.blueBlood");
         }
         else if(team == 2)
         {
