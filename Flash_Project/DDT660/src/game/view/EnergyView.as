package game.view
{
   ...
   public class EnergyView extends Sprite implements Disposeable
   {
      ...
      public function EnergyView(info:LocalPlayer, map:MapView = null)
      {
         ...
         this._bg = ComponentFactory.Instance.creatBitmap(backPath);
         addChild(this._bg);
      ...
      private function __enterFrame(event:Event) : void
      {
         ...
         {
            if(GameManager.Instance.Current.mapIndex == 1405 && !canPower)
            {
      ...
      private function __click(event:MouseEvent) : void
      {
         ...
         this._slider.x = this._hitArea.x + event.localX;
         dispatchEvent(new Event(Event.CHANGE));
         this._self.dispatchEvent(new LivingEvent(LivingEvent.MONKEY_CHANGED,event.localX * 4));
      }
