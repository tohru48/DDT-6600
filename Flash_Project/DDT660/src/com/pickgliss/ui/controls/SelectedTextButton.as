package com.pickgliss.ui.controls
{
   ...
   public class SelectedTextButton extends SelectedButton
   {
      ...
      public function set backgoundInnerRectString(param1:String) : void
      {
         ...
         {
            this._selectedBackgoundInnerRect = ClassUtils.CreatInstance(ClassUtils.INNERRECTANGLE,String(_loc2_[0]).split("|"));
         }
         if(_loc2_.length > 1 && _loc2_[1] != "")
         {
            this._unselectedBackgoundInnerRect = ClassUtils.CreatInstance(ClassUtils.INNERRECTANGLE,String(_loc2_[1]).split("|"));
         }
