package com.pickgliss.ui.controls
{
   ...
   public class ComboBox extends Component
   {
      ...
      public function set enable(param1:Boolean) : void
      {
         ...
         else if(Boolean(this.mGrayLayer))
         {
      ...
      override protected function onProppertiesUpdate() : void
      {
         ...
         if(Boolean(_changedPropeties[P_listInnerRect]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]) || Boolean(_changedPropeties[P_defaultShowState]) || Boolean(_changedPropeties[P_listPanel]))
         {
            this.onPosChanged();
            this.updateListSize();
            if(Boolean(this._listPanel))
         ...
         if(Boolean(_changedPropeties[P_textInnerRect]) || Boolean(_changedPropeties[Component.P_height]) || Boolean(_changedPropeties[Component.P_width]))
         {
