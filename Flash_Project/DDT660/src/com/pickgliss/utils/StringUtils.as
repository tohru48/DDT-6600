package com.pickgliss.utils
{
   ...
   public final class StringUtils
   {
      ...
      public static function center(param1:String, param2:uint, param3:String = " ") : String
      {
         ...
         if(param1.length < param2)
         {
            _loc5_ = uint(param2 - param1.length);
      ...
      public static function base64Encode(param1:String) : String
      {
         ...
         while(_loc3_ < _loc4_)
         {
            _loc5_ = param1.charCodeAt(_loc3_++) & 0xFF;
            if(_loc3_ == _loc4_)
            {
               _loc2_ += BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4) + "==";
               break;
            }
            _loc6_ = Number(param1.charCodeAt(_loc3_++));
            if(_loc3_ == _loc4_)
            {
               _loc2_ += BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4 | (_loc6_ & 0xF0) >> 4) + "=";
               break;
            }
            _loc7_ = Number(param1.charCodeAt(_loc3_++));
            _loc2_ += BASE64.charAt(_loc5_ >> 2) + BASE64.charAt((_loc5_ & 3) << 4 | (_loc6_ & 0xF0) >> 4) + BASE64.charAt((_loc6_ & 0x0F) << 2 | (_loc7_ & 0xC0) >> 6) + BASE64.charAt(_loc7_ & 0x3F);
         }
         return _loc2_;
      }
      ...
      public static function replaceValueByIndex(param1:String, ... rest) : String
      {
         ...
         while(Boolean(_loc3_) && rest.length > 0)
         {
            _loc4_ = int(_loc3_[1]);
