package com.pickgliss.loader
{
   ...
   public class UIModuleLoader extends EventDispatcher
   {
      ...
      {
         var _loc3_:int = int(this._queue.indexOf(param1));
         if(_loc3_ != -1)
         {
      ...
      private function __onZipParaComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = int(_loc2_.getFileCount());
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      {
         if(this._loadingLoaders.indexOf(param1) != -1)
         {
            this._loadingLoaders.splice(this._loadingLoaders.indexOf(param1),1);
         }
         if(this._queue.indexOf(param1.loadProgressMessage) != -1)
         {
      ...
      private function loadModuleConfig(param1:String, param2:String = "") : void
      {
         ...
         if(this._uiModuleLoadMode == CONFIG_XML)
         {
            _loc3_ = LoadResourceManager.Instance.createLoader(_baseUrl + ComponentSetting.getUIConfigXMLPath(param1),BaseLoader.TEXT_LOADER);
            ...
            if(this._loadingLoaders.indexOf(_loc3_) == -1)
            {
      ...
      {
         var _loc4_:BaseLoader = LoadResourceManager.Instance.createLoader(param1,BaseLoader.MODULE_LOADER);
         ...
         if(this._loadingLoaders.indexOf(_loc4_) == -1)
         {
