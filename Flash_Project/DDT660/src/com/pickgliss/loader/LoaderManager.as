package com.pickgliss.loader
{
   ...
   public class LoaderManager extends EventDispatcher
   {
      ...
      public function startLoad(param1:BaseLoader, param2:Boolean = false) : void
      {
         ...
         if(!LoadResourceManager.Instance.isMicroClient && (this._loadingLoaderList.length >= ALLOW_MUTI_LOAD_COUNT && !param2 || this.getLoadMode() == LOAD_NOT_SET))
         {
