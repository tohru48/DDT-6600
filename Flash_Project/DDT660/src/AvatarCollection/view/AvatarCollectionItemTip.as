package AvatarCollection.view
{
   ...
   public class AvatarCollectionItemTip extends BaseTip
   {
      ...
      {
         this._tempData = data as AvatarCollectionItemVo;
         if(!this._tempData)
         {
            return;
         }
         var tmp:ItemTemplateInfo = this._tempData.itemInfo;
         this._titleTxt.text = tmp.Name;
         this._typeValueTxt.text = LanguageMgr.GetTranslation("avatarCollection.itemTip.typeValueTxt",EquipType.PARTNAME[tmp.CategoryID]);
