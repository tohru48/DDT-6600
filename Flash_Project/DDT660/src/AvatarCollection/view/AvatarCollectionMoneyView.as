package AvatarCollection.view
{
   ...
   public class AvatarCollectionMoneyView extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         this._goldButton.tipData = LanguageMgr.GetTranslation("tank.view.bagII.GiftDirections",(60000 + vipNum).toString());
      ...
      {
         if(Boolean(evt.changedProperties[PlayerInfo.GOLD]) || Boolean(evt.changedProperties["myHonor"]))
         {
            this.refreshView();
         }
      }
