package campbattle.data
{
   ...
   public class CampModel
   {
      ...
      public var monsterPosList:Array = [[610,274],[1012,256],[860,264],[1122,264],[1254,266],[560,220],[604,324],[782,210],[796,334],[938,198],[1102,194],[1102,304],[1202,194],[1140,314],[914,278]];
      
      public function CampModel()
      {
         super();
         this.playerModel = new DictionaryData();
         this.monsterList = new DictionaryData();
      }
   }
}
