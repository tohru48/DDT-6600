package auctionHouse.view
{
   ...
   public class AuctionBagListView extends BagListView
   {
      ...
      public function AuctionBagListView(bagType:int, columnNum:int = 7)
      {
      ...
      override public function setData(bag:BagInfo) : void
      {
         ...
         {
            if(_cells[i] != null && _bagdata.items[i].IsBinds == false && _bagdata.items[i].TemplateID != EquipType.BATTLE_COMPANION && _bagdata.items[i].TemplateID != EquipType.MIDAUTUMN_PACKS)
            {
