package roomList.pvpRoomList
{
   ...
   public class RoomListCreateRoomView extends BaseAlerFrame implements Disposeable
   {
      ...
      protected function initContainer() : void
      {
         ...
         testBg.graphics.drawRect(this._explainTxt.x,this._explainTxt.y,this._explainTxt.width,this._explainTxt.height);
      ...
      protected function submit() : void
      {
         ...
         {
            GameInSocketOut.sendCreateRoom(this._explainTxt.text,4,3,this._checkBox.selected ? this._passTxt.text : "");
            this.hide();
         }
      }
