package worldboss.model
{
   public class WorldBossPackageType
   {
      ...
      public static const WORLDBOSS_PRIVATE_INFO:int = 22;
      
      public static const ASSISTANT:int = 39;
      
      public static const PlayerFightAssistant:int = 13;
      
      public static const WORLDBOSS_ALLPLAYERINFO:int = 14;
