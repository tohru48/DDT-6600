package worldboss.view
{
   ...
   public class RoomMenuView extends Sprite implements Disposeable
   {
      ...
      private function backRoomList(evt:MouseEvent) : void
      {
         ...
         var alert:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("worldboss.room.leaveroom"),LanguageMgr.GetTranslation("ok"),LanguageMgr.GetTranslation("cancel"),false,false,false,LayerManager.ALPHA_BLOCKGOUND);
