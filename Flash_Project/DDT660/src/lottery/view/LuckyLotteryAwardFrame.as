package lottery.view
{
   ...
   public class LuckyLotteryAwardFrame extends LotteryPopupFrame
   {
      ...
      public function setInfo(TemplateId:int, timeLimit:int) : void
      {
         this._awardCell.info = ItemManager.Instance.getTemplateById(TemplateId);
         this._awardCell.timeLimit = timeLimit;
      }
