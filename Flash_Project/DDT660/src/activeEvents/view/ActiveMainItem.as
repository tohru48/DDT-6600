package activeEvents.view
{
   ...
   public class ActiveMainItem extends Sprite implements Disposeable
   {
      ...
      public function set info(msg:ActiveEventsInfo) : void
      {
         this._info = msg;
         this.init();
         this.setText();
      ...
      private function _mouseClickHd(e:MouseEvent) : void
      {
      ...
      private function _mouseOutHd(e:MouseEvent) : void
      {
         if(!this._isSelect)
         {
      ...
      private function _mouseOverHd(e:MouseEvent) : void
      {
         this._itemBg.visible = true;
         this._text.setFrame(2);
         this.updatIconPos();
