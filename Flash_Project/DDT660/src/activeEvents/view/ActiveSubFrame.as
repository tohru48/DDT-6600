package activeEvents.view
{
   ...
   public class ActiveSubFrame extends Frame
   {
      ...
      public function set control(_value:ActiveController) : void
      {
         this._control = _value;
      }
      ...
      public function receiveItem($itemInfo:ActiveEventsInfo) : void
      {
         this._content.info = $itemInfo;
      }
      ...
      private function _frameEventHd(event:FrameEvent) : void
      {
      ...
      private function _closeBtnHd(event:MouseEvent) : void
      {
