package activeEvents.view
{
   ...
   public class ActiveSubContent extends Sprite implements Disposeable
   {
      ...
      public function set info(data:ActiveEventsInfo) : void
      {
         this._info = data;
      ...
      private function _activeGetBtnClick(event:MouseEvent) : void
      {
         ...
         this._loader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ActivePullDown.ashx"),BaseLoader.REQUEST_LOADER,args);
      ...
      {
         var loader:BaseLoader = evt.target as BaseLoader;
         ...
         MessageTipManager.getInstance().show(loader.content);
      }
