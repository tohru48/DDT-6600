package catchInsect.player
{
   ...
   public class SceneCharacterLoaderBody
   {
      ...
      private var _loaders:Vector.<CatchInsectSceneCharacterLayer>;
      ...
      {
         this._loaders = new Vector.<CatchInsectSceneCharacterLayer>();
         this._recordStyle = this._playerInfo.Style.split(",");
         this._recordColor = this._playerInfo.Colors.split(",");
         this._loaders.push(new CatchInsectSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],1,this._playerInfo.Sex));
         this._loaders.push(new CatchInsectSceneCharacterLayer(ItemManager.Instance.getTemplateById(int(this._recordStyle[4].split("|")[0])),this._recordColor[4],2,this._playerInfo.Sex));
      }
