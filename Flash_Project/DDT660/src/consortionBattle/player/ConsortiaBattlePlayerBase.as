package consortionBattle.player
{
   ...
   public class ConsortiaBattlePlayerBase extends SceneCharacterPlayerBase
   {
      ...
      private function showDefaultCharacter() : void
      {
         ...
         this._rectangle.x = 0;
         this._rectangle.y = 0;
         this._rectangle.width = this.playerWidth;
      ...
      private function sceneCharacterStateNatural() : void
      {
         ...
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalFrontHead","NaturalFrontAction",actionBmp,1,1,this.playerWidth,this.playerHeight,1,points,true,7));
         this._rectangle.x = this.playerWidth;
         this._rectangle.y = 0;
         this._rectangle.width = this.playerWidth;
         this._rectangle.height = this.playerHeight;
         actionBmp = new BitmapData(this.playerWidth,this.playerHeight,true,0);
         ...
         this._rectangle.x = this.playerWidth * 2;
         this._rectangle.y = 0;
         this._rectangle.width = this.playerWidth;
         this._rectangle.height = this.playerHeight;
         actionBmp = new BitmapData(this.playerWidth,this.playerHeight * 2,true,0);
         actionBmp.copyPixels(this._headBitmapData,this._rectangle,new Point(0,0));
         this._sceneCharacterSetNatural.push(new SceneCharacterItem("NaturalBackHead","NaturalBackAction",actionBmp,1,1,this.playerWidth,this.playerHeight,6,points,true,7));
