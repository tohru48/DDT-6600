package email.view
{
   ...
   public class EmailStrip extends Sprite implements Disposeable
   {
      ...
      {
         if(this._info.Type == 58 || this._info.Type == 13 || this._info.Type == EmailType.CONSORTION_EMAIL)
         {
            value = false;
         }
         if(this._info.Type == 13 || this._info.Type == 66)
         {
            value = true;
         }
      ...
      public function update() : void
      {
         ...
         else
         {
            ...
            if(this._info.Type == 58 || this._info.Type == 13 || this._info.Type == 66)
            {
               this._deleteBtn.enable = false;
               this._checkBox.enable = false;
               if(this._info.Type == 66 && this._info.Annex1 == null && this._info.Annex2 == null && this._info.Annex3 == null && this._info.Annex4 == null && this._info.Annex5 == null)
               {
      ...
      private function __delete(event:MouseEvent) : void
      {
         ...
         if((this.info.Money > 0 || this.info.BindMoney > 0 || this.info.hasAnnexs()) && this.info.Type != 81 && this.info.Type != 83)
         {
      ...
      private function __deleteAlertResponse(evt:FrameEvent) : void
      {
         ...
         if(Boolean(this._deleteAlert.parent))
         {
            this._deleteAlert.parent.removeChild(this._deleteAlert);
         }
         if(evt.responseCode == FrameEvent.CANCEL_CLICK || evt.responseCode == FrameEvent.CLOSE_CLICK || evt.responseCode == FrameEvent.ESC_CLICK)
         {
            this.cancel();
         }
